...
function w(a,b){var c=a.split("."),d=n;c[0]in d||"undefined"==typeof d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d[e]&&d[e]!==Object.prototype[e]?d=d[e]:d=d[e]={}:d[e]=b}
...
function O(a,b){M(a);a.i=!0;for(var c=v()+(b||a.l),d=a.a[4];d.length;){var e=d.shift(),t=a.c[e];delete a.c[e];t&&J(t)}d=a.v?0:1;d=a.f>d?a.f:d;if(!(v()>=c)){do{a:{e=a;t=d;for(var z=3;z>=t;z--)for(var P=e.a[z];P.length;){var Q=P.shift(),R=e.c[Q];delete e.c[Q];if(R){e=R;break a}}e=null}e&&J(e)}while(e&&v()<c)}a.i=!1;c=0;for(d=a.g.length;c<d;c++)e=a.g[c],a.a[e.priority].push(e.id);a.l=E;a:{for(c=3;0<=c;c--)if(a.a[c].length){c=!0;break a}c=!1}(c||a.g.length)&&a.start();a.g.length=0}
...
function ba(){N(V())}
function ca(a,b,c){if(0==c||void 0===c)return c=void 0===c,-K(V(),a,b,c);var d=window.setTimeout(function(){var c=K(V(),a,b);S[d]=c},c);
return d}
function da(a){I(V(),a)}
...
/*
     FILE ARCHIVED ON 03:19:04 Jun 25, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:39:24 Jan 26, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.093
  esindex: 0.009
  LoadShardBlock: 301.62 (6)
  PetaboxLoader3.datanode: 196.884 (7)
  load_resource: 303.862
  PetaboxLoader3.resolve: 273.076
*/