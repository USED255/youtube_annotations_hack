(function(self) {
    ...
    var join = function(col, a, b, var_args) {
      b = (0, self.z)(b, var_args || col.l);
      a = self.AF(a, "change", b, "iv-card-poll-choice-input");
      col.g.push(a);
    };
    /**
    ...
    var inject = function(exports) {
      if (!exports.g) {
        exports.g = new self.XC;
        self.N(exports, exports.g);
      }
      return exports.g;
    };
    /**
    ...
    var isFunction = function(arg) {
      arg.R("cardstatechange", self.cV(arg) && self.dV(arg) ? 1 : 0);
    };
    /**
     * @param {?} args
     * @return {?}
      ...
      for (;i < arguments.length;i++) {
        ...
        if (self.Aa(def)) {
          ...
          for (;depth < def.length;depth += 8192) {
            var styles = self.$a(def, depth, depth + 8192);
    ...
    var highlight = function(node) {
      if (self.Xta && (null !== node && "innerText" in node)) {
    ...
    var inverse = function(data) {
      return new self.bh(data.left, data.top, data.right - data.left, data.bottom - data.top);
    };
    /**
     * @param {Object} el
     * @return {?}
    ...
    var wrap = function(el) {
      return "rtl" == self.uh(el, "direction");
    };
    /**
     * @param {Object} n
     * @return {?}
    ...
    var load = function(n) {
      ...
      if (self.yd) {
        if (String(t) in data) {
          return self.Oh(n, result, "left", "pixelLeft");
        }
        if (n.parentNode && (1 == n.parentNode.nodeType && String(t) in COMMANDS)) {
          return n = n.parentNode, t = self.uh(n, "fontSize"), self.Oh(n, result == t ? "1em" : result, "left", "pixelLeft");
        }
      }
      t = self.K("SPAN", {
    ...
    var getData = function(element, key) {
      ...
      if (self.ek && element.dataset) {
        if (self.kc() && !(key in element.dataset)) {
          return null;
        }
        var value = element.dataset[key];
        return void 0 === value ? null : value;
      }
      return element.getAttribute("data-" + self.Hb(key));
    };
    /**
    ...
    var ok = function(value, msg, inEvent, a, inSender, keepCallback, message) {
      /** @type {Date} */
      this.date = self.ua(value) ? new Date(value, msg || 0, inEvent || 1, a || 0, inSender || 0, keepCallback || 0, message || 0) : new Date(value && value.getTime ? value.getTime() : (0, self.F)());
    };
    /**
    ...
    var exit = function() {
      var dt = (0, self.F)();
      self.Lb(empty, function(relativeToItem) {
    ...
    var resize = function(e, s, m, size, style, f, w) {
      ...
      m = self.Kh(s);
      w = w ? w.clone() : m.clone();
      e = self.WC(e, w, value, size, style, f);
      if (e.status & 496) {
        return e.status;
      }
      self.wh(s, self.gh(e.rect));
      w = self.fh(e.rect);
      if (!self.kd(m, w)) {
        size = w;
        style = self.md(s);
        f = self.vd(self.od(style).g);
        if (!self.yd || (self.rc("10") || f && self.rc("8"))) {
          s = s.style;
          if (self.rh) {
            /** @type {string} */
    ...
    var absBox = function(value, pos, item, mom, v, recurring, opt_attributes) {
      ...
      if (element = item.offsetParent) {
        ...
        if (!data || "static" != self.uh(element, "position")) {
          var position = self.Ch(element);
          if (!data) {
            data = wrap(element);
            var parent;
            if (parent = data) {
              parent = self.bM && self.Mn(10);
              var obj = self.Uta && 0 <= self.Cb(self.Fua, 10);
              parent = self.rh || (parent || obj);
            }
            data = parent ? -element.scrollLeft : !data || (self.oH && self.rc("8") || "visible" == self.uh(element, "overflowX")) ? element.scrollLeft : element.scrollWidth - element.clientWidth - element.scrollLeft;
            position = self.jd(position, new self.hd(data, element.scrollTop));
          }
        }
      }
      element = position || new self.hd;
      position = self.Lh(value);
      if (data = self.Dh(value)) {
        self.eh(position, inverse(data));
      }
      data = self.od(value);
      obj = self.od(item);
      if (data.g != obj.g) {
        parent = data.g.body;
        obj = self.Fh(parent, self.be(obj));
        obj = self.jd(obj, self.Ch(parent));
        if (!!self.yd) {
          if (!self.sc(9)) {
            if (!self.vd(data.g)) {
              obj = self.jd(obj, self.zd(data.g));
            }
          }
        }
        position.left += obj.x;
      ...
      pos = new self.hd(pos, position.top + (value & 1 ? position.height : 0));
      pos = self.jd(pos, element);
      if (v) {
    ...
    var onLoad = function(element, name) {
      if (element) {
        if (element.dataset) {
          delete element.dataset[self.$E(name)];
        } else {
    ...
    var hasKey = function(value, arg) {
      value = self.pd(value);
      arg = self.pd(arg);
      return!!self.Yd(value, function(val) {
        return val === arg;
      }, true, void 0);
    };
    /**
    ...
    var makeElement = function(name, y) {
      var names = self.qd(window.document, name, null, y);
     ...
     */
    var flush = function() {
      self.U(window.document.body, "hide-players", false);
      var r20 = self.rd("preserve-players");
      (0, self.B)(r20, function(onComplete) {
        self.mq(onComplete, "preserve-players");
      });
    };
    /**
     * @param {Element} node
    ...
    var unfoldSoak = function(second, deep) {
      if (second = self.pd(second)) {
        if (second.style) {
          self.O(second, deep);
          self.U(second, "hid", !deep);
        }
      }
    };
    /**
    ...
    var unbind = function(callback) {
      return(callback = self.pd(callback)) ? self.Nh(callback) && !self.kq(callback, "hid") : false;
    };
    /**
     * @param {?} value
     * @return {undefined}
    ...
    var removeClass = function(value) {
      (0, self.B)(arguments, function(o) {
        if (!self.Ba(o) || o instanceof window.Element) {
          unfoldSoak(o, true);
        } else {
          (0, self.B)(o, function(isXML) {
            removeClass(isXML);
          });
        }
      });
    ...
    var f = function(r, item, value, options) {
      ...
      if (value) {
        ...
        value = value.Cb();
        if (self.u(value) && -1 != value.indexOf("px")) {
    ...
    var insert = function(obj, v, path, value) {
      /** @type {number} */
      var newOptions = obj.Zd[0] - v * Math.cos(self.gd(value)) + v * Math.cos(self.gd(value + 90));
      /** @type {number} */
      var y = obj.Zd[1] - path * Math.sin(self.gd(value)) + path * Math.sin(self.gd(value + 90));
      obj.rb.push(3);
      obj.Ka.push(1);
    ...
    var min = function(data) {
      ...
      return viewSize ? viewSize.width / (data.o ? new self.I(data.o, data.K) : data.Hj()).width : 0;
    };
    /**
     * @param {?} b
     * @param {?} d
    ...
    var t = function(b, d, a, off, args, lang, ok, exports) {
      ...
      this.g = args;
      this.l = lang;
      this.o = self.t(ok) ? ok : null;
      this.A = self.t(exports) ? exports : null;
    };
    /**
     * @param {?} not
     * @param {number} value
    ...
    var QUnit = function(j, request, stateVal, opt_coordHeight, opt_acc) {
      ...
      this.l = {};
      this.M = self.Ad && !self.rc(526);
      this.I = new self.Lm(this);
    };
    /**
     * @param {Object} e
    ...
    var validator = function(dataAndEvents, line, baseValue) {
      var firstLength = self.vG;
      dataAndEvents = {
        csn : dataAndEvents,
        parentVisualElement : w(line),
        visualElements : (0, self.G)(baseValue, function(line) {
          return w(line);
        })
      };
    ...
    var expectData = function(length, opt_attributes) {
      /** @type {number} */
      opt_attributes.eventTimeMs = Math.round(self.hG());
      opt_attributes.lactMs = self.uG();
      self.dG({
    ...
    var init = function(options, id) {
      ...
      function $(item) {
        if (item) {
          ...
          if (item.runs) {
            return(0, self.G)(item.runs, function(script) {
              return script.text;
            }).join("");
          }
        }
      ...
      instance.impressionUrls = (0, self.G)(options.impressionUrls || [], drag);
      instance.skip = options.skipEndscreen;
      instance.visualElement = parseInt(options.trackingParams);
      var _bracketR = (0, self.G)(options.elements || [], function(elem, i) {
        ...
        element.clickUrls = (0, self.G)(data.loggingUrls || [], drag);
        element.qn = self.Tb(options, "title", "accessibility", "accessibilityData", "label");
        element.impressionUrls = (0, self.G)(options.impressionUrls || [], drag);
        element.MK = (0, self.G)(options.hovercardShowUrls || [], drag);
        element.Rd = {
        ...
        if ("VIDEO" == content) {
          ...
          if ("PLAYLIST" == content) {
            ...
            if ("CHANNEL" == content) {
              if (content = self.Tb(data, "browseEndpoint", "browseId")) {
                ...
                a: {
                  if (content = options.hovercardButton) {
                    if (content = content.subscribeButtonRenderer) {
                      ...
                      /** @type {null} */
                      var js = null;
                      if (options.signinEndpoint && (js = self.Tb(options, "signinEndpoint", "webNavigationEndpointData", "url"), !js)) {
                        options = void 0;
                        break a;
                      }
                      if (data && (css || js)) {
              ...
              if ("WEBSITE" == content) {
                element.targetUrl = self.Tb(data, "urlEndpoint", "url");
                /** @type {boolean} */
                element.Oo = true;
                /** @type {string} */
                element.mq = "new";
      ...
      instance.elements = (0, self.Ld)(_bracketR, function(dataAndEvents) {
    ...
    var Class = function(x) {
      ...
      this.K = [];
      x = self.Y(x);
      this.M = self.HM(x) || self.IM(x);
      /** @type {boolean} */
      this.LE = true;
      /** @type {number} */
      this.H = 0;
      this.I = new self.cp(null);
      this.C = new self.FF(this);
      self.N(this, this.C);
    ...
    var reset = function(data, b) {
      self.kV(data.g, "creatorendscreen");
      if (data.A) {
        data.A.dispose();
        /** @type {null} */
        data.A = null;
      ...
      if ((data.o = b) && b.elements) {
        ...
        /** @type {Array} */
        i = [];
        var j = new self.eQ(b.startMs, 0x7ffffffffffff, {
        ...
        if (!self.Y(data.g).l) {
          ...
          self.mV(data.g, data.A.element, 4);
          data.D = new self.MV(data.A, 200);
        }
        /** @type {number} */
        j = 0;
        for (;j < b.elements.length;++j) {
          ...
          self.mV(data.g, obj.element, 4);
          var copies = new self.eQ(object.startMs, object.endMs, {
    ...
    var put = function(data, options) {
      ...
      switch(options.type) {
          ...
          item = {
            ...
            N : [{
              ...
              N : [{
                ...
                P : {
                  dir : self.dp(data.I, options.title || "")
                },
                aa : options.title
              }, {
                G : "div",
        ...
        case "CHANNEL":
          ...
          item = new self.W(item);
          var parent = self.qd(window.document, "div", "ytp-ce-channel-subscribe", item.element)[0];
          if (options.subscribeButton) {
            self.S(parent, "ytp-ce-subscribe-button");
            if (self.Y(data.g).l) {
              /** @type {null} */
              var p = null;
      ...
      if (options.g) {
        self.S(item.element, "ytp-ce-placeholder");
      }
      return item;
    };
    /**
    ...
    var bind = function(data, node, callback) {
      ...
      node.U("mouseenter", (0, self.z)(data.Ut, data, node, callback));
      node.U("mouseleave", (0, self.z)(data.Ru, data, node, callback));
      if (!self.Y(data.g).l) {
        node.U("click", (0, self.z)(function(ev) {
          self.S(ev.element, "ytp-ce-element-hover");
        }, data, node));
      }
      node.U("click", (0, self.z)(data.HC, data, callback));
      node.U("keypress", (0, self.z)(data.HC, data, callback));
      node.U("focus", (0, self.z)(function(until, walkers) {
        this.Ut(until, walkers);
      }, data, node, callback));
      node.U("blur", (0, self.z)(function(relativeToItem, walkers) {
        this.Ru(relativeToItem, walkers);
      }, data, node, callback));
      node.U("touchstart", (0, self.z)(data.Ut, data, node, callback));
      var isDefault = self.J("ytp-ce-expanding-overlay-hider", node.element);
      if (isDefault) {
        node.O(isDefault, "touchstart", function(e) {
          ...
          self.mq(node.element, "ytp-ce-element-hover");
          self.mq(node.element, "ytp-ce-force-expand");
        });
      }
      node.U("keydown", (0, self.z)(function(dataAndEvents, e) {
        /** @type {boolean} */
        this.LE = 9 == e.keyCode && !e.shiftKey;
      }, data, node));
      var css = (0, self.z)(function(ev, obj, dataAndEvents) {
        this.H += dataAndEvents;
        if (0 < this.H) {
          self.S(ev.element, "ytp-ce-force-expand");
          sendMessage(this, obj.id, true);
        } else {
          self.mq(ev.element, "ytp-ce-force-expand");
          self.mq(ev.element, "ytp-ce-element-hover");
          sendMessage(this, obj.id, false);
        }
      }, data, node, callback);
      data = (0, self.z)(function(editable, win) {
        if (win) {
      ...
      data(self.J("ytp-sb-subscribe", node.element));
      data(self.J("ytp-sb-unsubscribe", node.element));
    ...
    var sendMessage = function(item, e, recurring) {
      ...
      for (i in item.l) {
        if (i != e) {
          self.U(item.l[i].element, "ytp-ce-element-shadow-show", recurring);
        }
      }
    };
    /**
    ...
    var set = function(a, obj, fn) {
      ...
      if (!obj || runLoggingCallbacks(self.Y(a.g).playerStyle)) {
        if (fn) {
          fn();
        }
      } else {
        ...
        /** @type {boolean} */
        var f = false;
        var fake_onhashchange = new self.Yt(function() {
          /** @type {boolean} */
          f = true;
          if (fn) {
            fn();
    ...
    var format = function(values) {
      return self.Aa(values) && values.length ? values[0] : values;
    };
    /**
     * @param {string} str
     * @return {?}
    ...
    var URI = function(str) {
      /** @type {RegExp} */
      var typePattern = /.+/;
      return self.u(str) && (null != typePattern && (null != str && str.match(typePattern))) ? str : "";
    };
    /**
     * @param {?} url
     * @param {string} error
    ...
    var abs = function(x, recurring) {
      return self.u(x) ? (0, window.parseFloat)(x) : recurring;
    };
    /**
     * @param {number} v
     * @param {number} recurring
    ...
    var pn = function(v, recurring, expectedNumberOfNonCommentArgs, v33, outstandingDataSize) {
      ...
      if (null != v && !(0, window.isNaN)(v)) {
        if (v33) {
          return self.dd(v, recurring, expectedNumberOfNonCommentArgs);
        }
    ...
    var trigger = function(gesture) {
      ...
      /** @type {number} */
      var d = 1;
      (0, self.B)(gesture, function(code) {
    ...
    var getValue = function(obj) {
      ...
      return(obj = obj ? new self.Zg((0, window.parseFloat)(obj.top), (0, window.parseFloat)(obj.right), (0, window.parseFloat)(obj.bottom), (0, window.parseFloat)(obj.left)) : null) && (val(obj.top) && (val(obj.right) && (val(obj.bottom) && val(obj.left)))) ? obj : null;
    };
    /**
     * @param {string} val
     * @return {?}
    ...
    var use = function(val) {
       ...
       */
      function fn(arg) {
        return(0, self.Ld)(arg.split(/ +/), function(val) {
          return "" != val;
        });
      }
    ...
    var call = function(opt_attributes) {
      ...
      var onComplete = self.Mc(success(opt_attributes.value));
      onComplete = self.Jc(onComplete);
      if (!onComplete) {
        return null;
      }
    ...
    var clear = function(node, obj) {
      var child = map(obj, action(node, new self.bh(node.x, node.y, node.Qk, node.o), obj.g));
      var options = obj.g;
      var result = child.clone();
      if (options) {
        if (!options.contains(child)) {
          if (child.width < options.width) {
            result.left = self.dd(child.left, options.left, options.left + options.width - child.width);
          } else {
            result.left = options.left;
            result.width = options.width;
          }
          if (child.height < options.height) {
            result.top = self.dd(child.top, options.top, options.top + options.height - child.height);
          } else {
    ...
    var action = function(o, i, value) {
      ...
      return new self.bh(0 == start ? 640 * i.left * result / 100 : 0 < start ? start : value.width + start - opts, 0 == height ? 360 * i.top * o / 100 : 0 < height ? height : value.height + height - baseline, opts, baseline);
    };
    /**
     * @param {string} args
     * @return {?}
    ...
    var execute = function(args, onComplete, sender) {
      (0, self.B)(args.g, self.Ga(onComplete, false), sender);
      (0, self.B)(args.o, self.Ga(onComplete, true), sender);
    };
    /**
     * @param {?} msg
     * @param {?} textStatus
    ...
    var isNaN = function(obj, msg) {
      return(0, self.Bj)(obj.o, msg, void 0);
    };
    /**
    ...
    var createTest = function(property, requestObj, dataAndEvents) {
      (0, self.B)(property.o, requestObj, dataAndEvents);
    };
    /**
     * @param {Object} a
    ...
    var array_to_hash = function(a, funcToCall) {
      return self.Ma(a.o, funcToCall, void 0);
    };
    /**
     * @param {Object} key
     * @param {Function} $p1
    ...
    var insertBefore = function(obj, opt_obj2) {
      (0, self.G)(obj.D, opt_obj2, void 0);
    };
    /**
     * @param {Function} c
     * @return {?}
    ...
    var Node = function(opt_parent, b, $0) {
      ...
      execute(b, function(o, doc) {
        ...
        this.l.subscribe(i, (0, self.z)(this.A, this, i, o));
        this.g[i] = o;
      }, this);
    };
    /**
    ...
    var SVG = function(name, opt_attributes, attr) {
      ...
      if (opt_attributes) {
        self.Lb(opt_attributes, function(idx, attribute) {
    ...
    var renderer = function(obj, p) {
      /** @type {string} */
      var pValue = ":" + (self.Su.getInstance().g++).toString(36);
    ...
    var open = function(title) {
      ...
      (0, self.B)(title, function(callback) {
        a: {
          switch(callback) {
            case "bevel":
    ...
    var makeArray = function(array) {
      array = (0, self.Ld)(array, function(code) {
        return code in frequency;
      });
      self.ib(array, function(b, a) {
    ...
    var getter = function(path) {
      return self.Ma(path, function(dataAndEvents) {
        return "dropshadow" == dataAndEvents;
      }) ? new self.Zg(0, 7, 7, 0) : new self.Zg(0, 0, 0, 0);
    };
    /**
     * @param {?} obj
     * @param {?} e
    ...
    var setup = function(s, data, index) {
      if (index.length && (data = self.qd(window.document, "g", void 0, data), data.length)) {
    ...
    var Game = function(initialState, debugMode, round, sock, rootModel) {
      ...
      this.wp = new self.Uk(this.JO, 100, this);
      self.N(this, this.wp);
      this.F = new self.Yt(this.Kz, 500, this);
      self.N(this, this.F);
      /** @type {null} */
    ...
    var bindEvents = function(type, eventMap) {
      var bind = (0, self.z)(function(deepDataAndEvents, iterator, initial) {
        iterator = initial ? addEventListener(this, iterator, (0, self.z)(initial, this)) : addEventListener(this, iterator);
    ...
    var listen = function(node) {
      if (node.g.B) {
        if (isNaN(node.g, function(packet) {
          ...
          node.A = self.K("DIV", "annotation-close-button");
          self.O(node.A, false);
          self.aF(node.A, "annotation_id", node.g.id);
    ...
    var addEventListener = function(dataAndEvents, callback, listener) {
      return(0, self.z)(function(e) {
        ...
        current = self.Lh(e.target);
        e = new self.hd(e.clientX, e.clientY);
    ...
    var show = function(node) {
      if (node.l || node.o) {
        ...
        if (s) {
          ...
          if (node.l) {
            s = clear(s, c);
            var options = self.W_(self.VU(node.C));
            self.Jh(node.l, s.width, s.height);
            self.wh(node.l, s.left, s.top);
            node.K = new self.bh(options.left + s.left, options.top + s.top, s.width, s.height);
            ...
            if (options.padding) {
              ...
              options = new self.Zg(options, options, options, options);
            }
            options = new self.Zg(360 * options.top * o / 100, 640 * options.right * g / 100, 360 * options.bottom * o / 100, 640 * options.left * g / 100);
            if (node.B) {
            ...
            /** @type {number} */
            var p = 0;
            var pos = self.W_(self.VU(node.C));
            var position = self.eV(node.C);
            if (self.dh(pos, position)) {
              /** @type {null} */
              pos = null;
            } else {
              position.top += 20;
            ...
            if (value && pos) {
              ...
              if (node.B) {
                ...
                data = o;
                self.Jh(node.B, o.width, o.height);
                self.wh(node.B, o.left, o.top);
              }
              if (node.A) {
                if (data) {
                  s = new self.hd(data.left + data.width - 23 - 18, node.Z ? data.top + 2 : data.top + data.height - 18 - 2);
                } else {
                  data = layout(node, 18, s, options, g);
                  s = new self.hd(data.left, data.top);
                  self.Jh(node.A, data.width, data.height);
                }
                self.wh(node.A, s);
              }
              node.M = new self.bh(node.K.left + data.left, node.K.top + data.top, data.width, data.height);
              node.J = node.W.U(self.VU(node.C), "mousemove", node.KO, node);
            } else {
              if (node.B) {
                /** @type {number} */
                data = g / o * options.height * 4.2 / 100;
                data = new self.I(data, data);
                if ("highlight" == node.g.type || "label" == node.g.style) {
                  /** @type {number} */
                  g = 1.5 * options.height / 100;
                  data = new self.bh(s.width - data.width - g, s.height - data.height - g, data.width, data.height);
                } else {
                  data = new self.bh(s.width - data.width - 3 * options.height / 100, (s.height - data.height) / 2, data.width, data.height);
                }
                self.Jh(node.B, data.width, data.height);
                self.wh(node.B, data.left, data.top);
              }
              if (node.A) {
                /** @type {boolean} */
                ...
                self.wh(node.A, data && g ? new self.hd(s.width - 9, -9) : data ? new self.hd(s.width - 9, 45 < s.height ? 9 : s.height - 9) : g ? new self.hd(45 < s.width ? s.width - 9 - 18 : -9, -9) : s.width / options.width > s.height / options.height ? new self.hd(45 < s.width ? s.width - 9 - 18 : -9, s.height - 9) : new self.hd(-9, 45 < s.height ? 9 : s.height - 9));
              }
            }
          }
          if (node.o) {
          ...
          if (node.l) {
            ...
            data = (s = self.J("annotation-link-icon", node)) ? self.Nh(s) : false;
            g = (options = self.J("annotation-close-button", node)) ? self.Nh(options) : false;
            if (data) {
              self.O(s, false);
            }
            if (g) {
              self.O(options, false);
            }
            /** @type {string} */
            p = o = "";
            if (pos = self.J("inner-text", node)) {
    ...
    var layout = function(pos, size, el, options, type) {
      /** @type {boolean} */
      var f = 0 < type;
      size = new self.bh(0, el.height - size, Math.max(el.width, size), size);
      if (0 < options) {
        size.top = el.height;
        if (20 < options) {
          size.height += options - 20;
        }
        self.S(pos.l, "annotation-extend-down");
      }
      if (f) {
        /** @type {number} */
        ...
        self.S(pos.l, "annotation-extend-up");
        /** @type {boolean} */
        pos.Z = true;
      }
      return size;
    ...
    var reposition = function(o) {
      var item = self.W_(self.VU(o.C));
      if ("player_relative" == o.g.C) {
        var $cont = self.VU(o.C).Oa();
        item = new self.bh(-item.left, -item.top, $cont.width, $cont.height);
      } else {
        item = new self.bh(0, 0, item.width, item.height);
      }
    ...
    var scroll = function(b, item) {
      return item ? new self.bh(b.x + item.left, b.y + item.top, item.width, item.height) : null;
    };
    /**
     * @param {?} node
     * @param {string} query
    ...
    var Property = function(params) {
      this.merchant = self.E(params.merchant);
      this.price = self.E(params.price);
    };
    /**
     * @param {?} error
     * @param {?} data
    ...
    var isUndefinedOrNull = function(value) {
      ...
      self.bV(value.g, "iv", millis, void 0);
    };
    /**
     * @param {?} data
     * @param {?} index
    ...
    var sortedIndex = function(array, iterator) {
      return iterator ? (0, self.G)(array, self.Ga(function(funcToCall, onComplete) {
        return self.Um(onComplete, funcToCall);
      }, iterator)) : array;
    };
    /**
     * @param {Object} o
    ...
    var remove = function(o, s, value, sel) {
      ...
      if (30 == value["a-type"]) {
        a: {
          ...
          o = o.g.getVideoData();
          if (o.Ax) {
            if ((s = o.Ax[s]) && self.hH(s)) {
              o = self.pb("[ANNOTATION_ID]");
    ...
    var keys = function(obj, object, key, success, $keys) {
      ...
      (0, self.B)(key || [], function(onComplete) {
        f++;
        self.FE(onComplete, done);
      });
      if ($keys) {
        f++;
        if (0 != $keys) {
    ...
    var iterate = function(obj, key) {
      var value = {};
      if (key) {
        var node = new self.Cm(key);
        (0, self.B)(node.Bb(), function(property) {
          value[property] = (0, window.escape)(node.get(property, ""));
        });
      }
      value["p-time"] = obj.g.getCurrentTime().toFixed(2);
      value.ps = self.Y(obj.g).playerStyle;
      return value;
    };
    /**
     * @param {?} obj
    ...
    var fn = function(event, o) {
      ...
      if (o.A) {
        expectationResult["aria-label"] = self.O0("$POLL_TITLE - Sign in to vote.", {
          POLL_TITLE : o.title
        });
      }
      /** @type {Array} */
      ...
      QUnit = out.element;
      onComplete(o, QUnit);
      join(event.g.g, QUnit, self.Ga(event.D, o), event);
      (0, self.B)(self.rd("iv-card-poll-choice-input", QUnit), function(deepDataAndEvents) {
        this.g.g.U(deepDataAndEvents, "focus", self.Ga(this.o, true));
        this.g.g.U(deepDataAndEvents, "blur", self.Ga(this.o, false));
      }, event);
      if (o.A) {
        QUnit = self.J("iv-card-sign-in-button", QUnit);
    ...
    var get = function(options, obj) {
      ...
      /** @type {Array} */
      var deltaPath = [];
      (0, self.B)(obj.metaInfo, function(initial) {
    ...
    var createNode = function(settings, obj) {
      ...
      html.dir = self.dp(settings.l, obj.customMessage);
      /** @type {Array} */
      var oSpace = [{
        G : "span",
    ...
    var onComplete = function(data, b) {
      /** @type {number} */
      var count = 0;
      (0, self.B)(data.choices, function(d) {
        count += d.count;
      });
      count = count || 1;
      /** @type {number} */
      ...
      for (;i < data.choices.length;i++) {
        ...
        var d = self.J(data.B + "-" + a.index.toString(), b);
        /** @type {number} */
        a = a.count / count;
        if (null == data.g) {
          /** @type {number} */
        ...
        self.U(d.getElementsByTagName("label")[0], "iv-card-poll-choice-checked", data.g == i);
        /** @type {boolean} */
        d.getElementsByTagName("input")[0].checked = data.g == i;
        /** @type {string} */
        var PERCENT = Math.floor(100 * a).toFixed(0);
        var m = self.J("iv-card-poll-choice-percent", d);
        self.Sd(m, self.O0("$PERCENT%", {
          PERCENT : PERCENT
        }));
        d = self.J("iv-card-poll-result-bar", d);
        self.ph(d, "transform", "scaleX(" + a.toFixed(2) + ")");
      }
      self.U(b, "iv-card-poll-voted", null != data.g);
      self.U(b, "iv-card-poll-expanded", null != data.g && 1 < data.choices.length);
    };
    /**
     * @param {Object} model
     * @param {Object} result
    ...
    var extend = function(props, b, d, xs, a) {
      if (d.g) {
        setProperties(props, self.rd("iv-card-sign-in-button", b.element), d, d.g, a);
      }
      if (d.url) {
        setProperties(props, self.rd("iv-click-target", b.element), d, d.url, xs);
      }
    };
    /**
    ...
    var setProperties = function(props, into, c, properties, hash) {
      (0, self.B)(into, function(exports) {
        if (hash) {
          var r20 = (0, self.z)(function(event) {
    ...
    var stringify = function(a) {
      ...
      a = a.split("#", 2);
      return!a || 2 > a.length ? null : (a = self.bE(a[1])) && a.t ? toString(a.t) : -1;
    };
    /**
     * @param {string} val
     * @return {?}
    ...
    var change = function(val) {
      ...
      return push(val) ? (val = self.dE(val)) && val.v ? val.v : null : null;
    };
    /**
     * @param {string} v
    ...
    var create = function(config, assert, opt_attributes, left, scope, container) {
      assert = new self.eQ(assert, opt_attributes, {
        id : left
      });
      self.N(config, assert);
      /** @type {string} */
      ...
      self.hV(config.context.l, [assert]);
    };
    /**
     * @param {Object} b
     * @return {?}
    ...
    var sort = function(options, data, b, a, deepDataAndEvents, value) {
      ...
      if (message) {
        ...
        var response = (0, self.z)(function() {
          if (data.g) {
            this.context.l.hd();
          }
          self.vV(message || "", "current" == node ? "_top" : void 0, b);
        }, options);
        if ("new" == node) {
          response();
          /** @type {null} */
    ...
    var loop = function(domEl, val, data) {
      ...
      /** @type {null} */
      this.X = null;
      this.J = new self.Yt(self.y, data.B.useTabletControls ? 4E3 : 3E3);
      self.N(this, this.J);
      this.na = new self.Yt(self.y);
      self.N(this, this.na);
      this.C = new Matrix(data, (0, self.z)(this.Zi, this), (0, self.z)(this.Uo, this));
      this.H = new self.W({
        G : "div",
        L : "iv-drawer",
        P : {
      ...
      this.ca = new self.MV(this.H, 330);
      self.N(this, this.ca);
      this.Da = self.J("iv-drawer-header-text", this.D);
      this.A = self.J("iv-drawer-content", this.D);
      /** @type {Array} */
      this.o = [];
      /** @type {null} */
    ...
    var animate = function(item, options) {
      ...
      if (data && cache[data]) {
        ...
        if (!item.sa) {
          self.lq(item.la(), ["html5-stop-propagation", "iv-drawer-manager"]);
          self.mV(item.g, item.D, 5);
          stop(item);
          item.K = self.J("ytp-cards-button", item.g.getRootNode());
          var index = self.J("iv-drawer-close-button", item.D);
          item.ra = index;
          /** @type {boolean} */
          item.sa = true;
        }
        ...
        if (result) {
          ...
          self.ab(item.o, length, 0, index);
          result.ua(item.A, length);
          item.Fn();
          if (data.autoOpen) {
            create(item, data.startMs, 0x8000000000000, data.id, self.Ga(item.MV, index));
          } else {
            /** @type {number} */
            ...
            create(item, data.startMs, data.startMs + 1, data.id, self.Ga(item.kE, index));
            trim(item);
          }
        }
      }
    ...
    var handler = function(item, deepDataAndEvents, type, e) {
      if (!item.B) {
        item.ca.show();
        item.Z = new self.Yt(function() {
          self.S(item.context.l.getRootNode(), "ytp-iv-drawer-open");
        }, 0);
        item.Z.start();
        item.X = self.rF(item.A, "mousewheel", (0, self.z)(item.ZM, item));
        /** @type {boolean} */
        item.B = true;
        item.Y = (0, self.F)();
        before(item.context.logger, item.M, 7, void 0, e && e.hc ? e.hc.o : void 0);
        var pdataCur = self.MG();
        if (pdataCur) {
          if (item.ea) {
            if (item.I) {
        ...
        (0, self.B)(item.o, function(url_parts) {
          if (!url_parts.BA) {
            /** @type {boolean} */
            url_parts.BA = true;
    ...
    var complete = function(c) {
      if (c.B) {
        ...
        /** @type {null} */
        c.X = null;
        self.mq(c.context.l.getRootNode(), "ytp-iv-drawer-open");
        /** @type {boolean} */
        c.B = false;
        isFunction(c.g);
        if (c.F) {
    ...
    var stop = function(item) {
      var r20 = self.J("iv-drawer-close-button", item.D);
      ...
      item.context.o.subscribe("onVideoAreaChange", function() {
        item.T = self.kq(item.g.getRootNode(), "ytp-autohide");
      });
      item.ha.push(self.UF("iv-teaser-shown", item.YL, item));
      item.ha.push(self.UF("iv-teaser-clicked", item.XL, item));
    };
    /**
     * @param {Object} options
     * @param {Object} data
    ...
    var render = function(options, data) {
      switch(data.type) {
        ...
        case "collaborator":
          ...
          value = new self.W(value);
          extend(settings, value, data);
          return value;
        case "donation":
          return settings = options.C, value = (0, self.z)(settings.C, settings, data), parse(settings, data, value, value);
        case "episode":
        ...
        case "playlist":
          ...
          }, value = new self.W(value), extend(settings, value, data), value;
        case "poll":
          return fn(options.C, data);
        case "productListing":
          settings = options.C;
          /** @type {boolean} */
          var result = !self.Ra(data.offers);
          /** @type {Array} */
          value = ["iv-card"];
          /** @type {string} */
          var info = "";
          ...
          value = new self.W(value);
          info = self.Ed("span");
          self.Sd(info, "You are seeing this product because we think it is relevant to the video. Google may be compensated by the merchant.");
          value.Mb(info, "adInfo");
          extend(settings, value, data);
          return value;
        case "tip":
          return settings = options.C, value = (0, self.z)(settings.F, settings, data), parse(settings, data, value, value);
        case "video":
    ...
    var _init = function(data, o) {
      ...
      var b = self.Na(data.o, function(e) {
    ...
    var register = function(a) {
      return a.l ? "productListing" == a.l.hc.type : (0, self.dm)(a.o, function(e) {
    ...
    var trim = function(value) {
      self.U(value.g.getRootNode(), "ytp-cards-shopping-active", register(value));
    };
    /**
     * @param {Object} dom
     * @param {Object} e
    ...
    var id = function(rec, name) {
      return self.Ma(rec.o, function(e) {
        return e.hc.id == name;
      });
    };
    /**
    ...
    var s = function(attr, args, u) {
      ...
      /** @type {null} */
      this.A = null;
      this.D = self.K("DIV", "iv-promo-contents");
      /** @type {null} */
      this.l = this.o = this.g = null;
      this.C = new self.Yt(function() {
    ...
    var update = function(node) {
      ...
      if (s) {
        var body = self.K("DIV", ["iv-promo-img", "iv-click-target"]);
        s = self.K("IMG", {
          src : s,
          "aria-hidden" : "true"
        });
        ...
        if (opts.video_duration && !opts.is_live) {
          s = self.K("SPAN", "iv-promo-video-duration", opts.video_duration);
          body.appendChild(s);
        } else {
          if (opts.playlist_length) {
            s = self.K("SPAN", "iv-promo-playlist-length", opts.playlist_length.toString());
            body.appendChild(s);
          }
        }
        if (value) {
      ...
      if (value) {
        s = self.K("A", "iv-promo-txt");
        self.ad(s, parseFloat(value));
        node.g = s;
      } else {
        node.g = self.K("DIV", "iv-promo-txt");
      }
      switch(node.annotation.style) {
        case "cta":
        ;
        case "website":
          var p = self.K("P", null, self.K("STRONG", null, opts.text_line_1));
          var cell = self.K("P", null, self.K("SPAN", "iv-promo-link", opts.text_line_2));
          if (s = opts.text_line_3) {
            authHeader.push("iv-promo-website-card-cta-redesign");
            var rvar = self.K("BUTTON", ["iv-promo-round-expand-icon", "ytp-button"]);
            s = self.K("BUTTON", ["iv-button", "iv-promo-button"], self.K("SPAN", "iv-button-content", s));
            var div = self.K("DIV", "iv-promo-button-container");
            div.appendChild(s);
            if (value) {
              node.Zi(node.la(), value, node.annotation.id, opts.session_data, node.annotation.g, void 0, key);
            }
          }
          self.S(node.g, "iv-click-target");
          if (value) {
        ...
        ;
        case "video":
          p = self.K("P", null, self.K("SPAN", null, opts.text_line_1));
          cell = self.K("P", null, self.K("STRONG", null, opts.text_line_2));
          if (opts.is_live) {
            p = cell;
            cell = self.K("SPAN", ["yt-badge", "iv-promo-badge-live"], "LIVE NOW");
          }
          self.S(node.g, "iv-click-target");
          if (value) {
            node.Zi(node.g, value, node.annotation.id, opts.session_data, node.annotation.g, void 0, key);
          ...
          break;
        case "vote":
          p = self.K("P", null, self.K("STRONG", null, opts.text_line_1));
          cell = self.K("P", null, self.K("SPAN", null, opts.text_line_2));
          div = self.K("DIV", "iv-promo-button-container");
          key = self.K("BUTTON", ["iv-button", "iv-promo-button"], self.K("SPAN", "iv-button-content", opts.button_text));
          node.context.g.U(key, "click", function(event) {
            ...
            this.g = self.J("iv-promo-txt", this.D);
            var curr = self.J("iv-promo-button-container", this.D);
            var body = self.K("DIV", ["iv-promo-txt", "iv-click-target"]);
            var node = self.K("P", null, self.K("STRONG", null, event.text_line_3));
            var expected = self.K("P", null, event.text_line_4);
            self.Hd(body, node, expected);
            self.Kd(curr);
            curr = this.g;
            if (node = curr.parentNode) {
              node.replaceChild(body, curr);
            }
            self.mq(this.la(), "iv-promo-with-button");
      ...
      p = self.K("DIV", "iv-promo-actions");
      node.l = self.K("BUTTON", ["iv-promo-expand", "ytp-button"]);
      /** @type {string} */
      node.l.title = "Expand";
      node.context.g.U(node.l, "click", self.Ga(node.ys, 5E3), node);
      p.appendChild(node.l);
      self.O(node.l, false);
      node.context.g.U(node.la(), "mouseover", node.fK, node);
      node.context.g.U(node.la(), "mouseout", node.eK, node);
      node.context.g.U(node.la(), "touchend", self.Ga(node.ys, 5E3), node);
      node.o = self.K("BUTTON", ["iv-promo-close", "ytp-button"]);
      ...
      self.lq(node.la(), authHeader);
      if (body) {
        self.Gd(node.la(), body);
        if (rvar) {
          body.appendChild(rvar);
        }
      }
      self.Gd(node.la(), node.D);
      self.Gd(node.la(), p);
    };
    /**
     * @param {Object} obj
    ...
    var makeGrammar = function(obj) {
      if (!obj.B) {
        if (!obj.H) {
          if (!obj.A) {
            self.S(obj.la(), "iv-promo-collapsed");
            /** @type {boolean} */
            obj.B = true;
            obj.C.start();
          }
    ...
    var toggle = function(o) {
      o.C.stop();
      if (o.B) {
        self.nq(o.la(), ["iv-promo-collapsed", "iv-promo-collapsed-no-delay"]);
        /** @type {boolean} */
        o.B = false;
        if (o.g) {
    ...
    var run = function(i) {
      ...
      this.F = new self.FF(this);
      self.N(this, this.F);
      /** @type {null} */
      this.D = this.B = null;
      this.F.O(this.g, "onVideoAreaChange", (0, self.z)(this.R, this, "onVideoAreaChange"));
      this.F.O(this.g, "onHideControls", (0, self.z)(this.R, this, "onHideControls"));
      this.F.O(this.g, "onShowControls", (0, self.z)(this.R, this, "onShowControls"));
      this.F.O(this.g, "resize", (0, self.z)(this.R, this, "resize"));
      this.F.O(this.g, "presentingplayerstatechange", (0, self.z)(this.R, this, "presentingplayerstatechange"));
      ...
      self.Y(this.g).C.subscribe("vast_info_card_add", this.lD, this);
      this.X = new self.FF(this);
      self.N(this, this.X);
      this.X.O(this.g, "crn_annotations_module", this.yM);
      this.X.O(this.g, "crx_annotations_module", this.zM);
      this.T = self.K("DIV", ["video-legacy-annotations", "html5-stop-propagation"]);
      this.Z = self.K("DIV", "video-custom-annotations");
      this.A = new self.W({
        G : "div",
        da : ["ytp-player-content", "ytp-iv-player-content"]
      });
      self.N(this, this.A);
      self.mV(this.g, this.A.element, 4);
      this.A.hide();
      this.C = new self.W({
        G : "div",
      ...
      self.N(this, this.C);
      self.Gd(this.C.element, self.K("DIV", "video-annotations", this.T, this.Z));
      /** @type {null} */
      this.H = this.l = null;
      /** @type {Array} */
      this.M = [];
    ...
    var append = function(value, v) {
      var div = self.K("DIV", ["annotation", "annotation-type-custom"]);
      self.O(div, false);
      /** @type {null} */
      var ret = null;
      switch(v.type) {
        case "branding":
          if (self.Y(value.g).Bd) {
            break;
          }
    ...
    var post = function(data) {
      ...
      if (msg.Of) {
        ...
        if (applyArgs) {
          ...
          params.wd = (0, self.z)(function(res, deepDataAndEvents, x) {
            if (!node(this, res, deepDataAndEvents)) {
              if (res = self.WD(x) && x.responseXML ? x.responseXML : null) {
                go(this, res);
              }
            }
    ...
    var iterator = function(value) {
      var oldconfig = new self.W({
        G : "div"
      });
      self.O(oldconfig.element, false);
    ...
    var hasOwnProperty = function(exports) {
      if (!exports.H) {
        var oldconfig = new self.CF(exports);
        self.N(exports, oldconfig);
        var QUnit = new self.Lm(exports);
        self.N(exports, QUnit);
        exports.H = new Color(oldconfig, QUnit, self.Y(exports.g), exports.g.getVideoData(), exports.Ya, exports.g, exports.ea);
      }
      return exports.H;
    };
    /**
    ...
    var fail = function(b, i) {
      ...
      return g.videoId == item ? true : self.Y(b.g).g && g.yn ? true : false;
    };
    /**
     * @param {Node} a
     * @param {number} obj
    ...
    var compare = function(a, obj) {
      if (size(obj)) {
        ...
        return new Game(obj, (0, self.z)(a.T.appendChild, a.T), a.g, a.ea, c);
      }
      return null;
    };
    /**
    ...
    var fetch = function(where, value) {
      return(0, self.z)(function() {
        if (!this.ka()) {
          /** @type {Array.<?>} */
          var args = Array.prototype.slice.call(arguments, 0);
          args.unshift(value);
          value = self.Ga.apply(window, args);
          this.M.push(self.lG(value));
        }
      }, where);
    };
    /**
    ...
    var commit = function(type, body, html) {
      ...
      return self.Yd(html, function(onComplete) {
        return self.kq(onComplete, body);
      }, true, parameter);
    };
    /**
     * @param {Object} event
      ...
      if ("HTML" != event.target.tagName && p) {
        if (type) {
          ...
          for (i in p.l) {
            ...
            if (value) {
              if (!self.Yd(event.relatedTarget, function(el) {
                return el == value;
              }, true)) {
    ...
    var subscribe = function(obj, topic, listener) {
      obj.H.push(self.UF(topic, listener, obj));
    };
    /**
     * @param {?} target
     * @param {?} event
    ...
    var addListener = function(target, event, listener) {
      target.F.push(self.FN(event, listener, target));
    };
    /**
     * @return {undefined}
     */
    ...
    var save = function(target, object, data, event, callback) {
      ...
      if (k || (32 == event.keyCode || 13 == event.keyCode)) {
        ...
        if (newState) {
          ...
          /** @type {number} */
          target = self.kq(object, $(target, "reverse")) ? 38 : 40;
    ...
    var cont = function(param, elem, style) {
      self.S(style, $(param, "menu-item-highlight"));
      var name = style.getAttribute("id");
      if (!name) {
        name = $(param, "item-id-" + self.Fa(style));
    ...
    var position = function(node, context, n, value) {
      var key = self.$d(context, $(node, "group"));
      /** @type {boolean} */
      ...
      /** @type {number} */
      var mom = 8;
      var res = self.Lh(context);
      if (self.kq(context, $(node, "reverse"))) {
        /** @type {number} */
        slideIndex = 8;
        /** @type {number} */
        mom = 9;
      ...
      if (r) {
        var m = self.Lh(r);
        m = new self.Zg(-m.top, m.left, m.top, -m.left);
      }
      r = new self.hd(0, 1);
      if (self.kq(context, $(node, "center-menu"))) {
        r.x -= Math.round((self.Kh(n).width - self.Kh(context).width) / 2);
      }
      if (value) {
        r.y += self.zd(window.document).y;
      }
    ...
    var draw = function(node, element) {
      if (element) {
        ...
        i = self.$d(element, $(node, "group"));
        /** @type {Array} */
        var items = [$(node, "active")];
        if (i) {
          items.push($(node, "group-active"));
        }
        self.nq(element, items);
        self.XF("yt-uix-button-menu-hide", element);
        self.sF(node.o);
        /** @type {number} */
        node.o.length = 0;
      }
    ...
    var setAttribute = function(node, value, el) {
      ...
      node = self.rd(x, value);
      (0, self.B)(node, function(onComplete) {
        self.mq(onComplete, x);
      });
      self.S(el.parentNode, x);
    };
    /**
     * @param {Object} source
     * @param {?} key
    ...
    var spawn = function(source, key) {
      if (!key.widgetMenu) {
        ...
        data = data && self.pd(data);
        var ok = $(source, "menu");
        if (data) {
          self.lq(data, [ok, $(source, "menu-external")]);
        } else {
          data = self.J(ok, key);
        }
        key.widgetMenu = data;
    ...
    var callback = function(html, name, value) {
      ...
      var test = $(html, "card");
      value = html.Cc(body);
      var node = self.pd($(html, "card") + write(body));
      if (node) {
        return html = self.J($(html, "card-body"), node), self.Qd(html, value) || (self.Kd(value), html.appendChild(value)), node;
      }
      node = window.document.createElement("div");
      node.id = $(html, "card") + write(body);
      node.className = test;
      if (body = html.Ba(body, "card-class")) {
        self.lq(node, body.split(/\s+/));
      }
    ...
    var start = function(element, node, t) {
      ...
      var a = self.J($(element, "anchor"), node) || node;
      ...
      if (i) {
        ...
        var corner = new self.hd(-12, node.offsetHeight + 6);
      } else {
        /** @type {number} */
        x = node.offsetWidth / 2 - 6;
        corner = new self.hd(node.offsetWidth + 6, -12);
      }
      var result = self.Kh(t);
      /** @type {number} */
      ...
      if (normalizedRange) {
        ...
        b = self.zd(window.document).y;
        self.ph(t, "position", "fixed");
        self.ph(t, "top", a - b + "px");
      }
      if (not) {
        /** @type {string} */
        t.style.right = "";
      ...
      a = self.J("yt-uix-card-body-arrow", t);
      b = self.J("yt-uix-card-border-arrow", t);
      /** @type {string} */
      ...
      /** @type {string} */
      b.style[i] = x + "px";
      h = self.J("yt-uix-card-arrow", t);
      pass = self.J("yt-uix-card-arrow-background", t);
      if (h) {
        if (pass) {
          /** @type {number} */
          t = "right" == i ? self.Kh(t).width - x - 13 : x + 11;
          /** @type {number} */
          x = t / Math.sqrt(2);
          /** @type {string} */
          h.style.left = t + "px";
    ...
    var add = function(t) {
      ...
      if (!opt) {
        ...
        /** @type {string} */
        opt.src = 'javascript:""';
        self.lq(opt, ["yt-uix-card-iframe-mask"]);
        t.cardMask = opt;
      }
    ...
    var emit = function(key, data, element) {
      if (data && element) {
        if (self.S(element, $(key)), key = data.id, key || (key = "kbd-nav-" + Math.floor(1E6 * Math.random() + 1), data.id = key), data = key, self.ek && element.dataset) {
          /** @type {Object} */
          ...
          element.setAttribute("data-" + self.Hb("kbdNavMoveOut"), data);
        }
      }
    };
    /**
    ...
    var activate = function(target, container) {
      if (container) {
        var li = self.Zd(container, "LI");
        if (li) {
          self.S(li, $(target, "highlight"));
          bounds = self.rF(container, "blur", (0, self.z)(function(onComplete) {
            self.mq(onComplete, $(this, "highlight"));
            self.sF(bounds);
          }, target, li));
        }
      }
    ...
    var recurse = function(x) {
      ...
      x = (0, self.Ld)(self.Md(x), function(elem) {
        return "LI" == elem.tagName.toUpperCase();
      });
      return(0, self.Ld)((0, self.G)(x, function(element) {
        return unbind(element) ? isEmpty(element, function(dest) {
          return self.Da(dest) && 1 == dest.nodeType ? self.Xd(dest) : false;
        }) : false;
    ...
    var decode = function(s) {
      ...
      var index = out.pe(s);
      return index ? index : self.$d(s, $(out, "content")) == out.g ? out.l : null;
    };
    /**
     * @param {Object} obj
     * @param {(Object|number)} value
    ...
    var group = function(obj, value, id) {
      ...
      if (id == obj.g) {
        ...
        /** @type {number} */
        var mom = 8;
        if (self.kq(value, $(obj, "reversed"))) {
          slideIndex ^= 1;
          mom ^= 1;
        }
        if (self.kq(value, $(obj, "flipped"))) {
          slideIndex ^= 4;
          mom ^= 4;
        }
        obj = new self.hd(0, 1);
    ...
    var resolve = function(item, value, dataAndEvents) {
      if (reject(item, value) && !dataAndEvents) {
        ...
        if (!item.g || hasKey(value, item.g)) {
          ...
          then(item.A, (0, self.z)(item.fG, item, value));
        }
      }
    };
    /**
    ...
    var rename = function(obj, callback) {
      if (callback) {
        var cb = self.$d(callback, $(obj, "content"));
        if (cb) {
          cb = self.rd($(obj), cb);
          (0, self.B)(cb, function(isXML) {
    ...
    var enqueue = function(obj, value) {
      if (value) {
        ...
        if (keys) {
          keys = self.rd($(obj), keys);
          keys = self.Ya(keys);
          /** @type {Array} */
          values = values.concat(keys);
          (0, self.B)(values, function(isXML) {
            if (reject(this, isXML)) {
              isNode(this, isXML);
            }
          }, obj);
    ...
    var isNode = function(obj, value) {
      if (value) {
        ...
        self.nq(resultSelector(obj, value), [$(obj, "trigger-selected"), "yt-uix-button-toggled"]);
        self.S(n, $(obj, "content-hidden"));
        ...
        self.XF("yt-uix-menu-hide", value);
        n = self.Fa(value).toString();
        self.sF(obj.o[n]);
        delete obj.o[n];
      }
    };
    ...
    var store = function(obj, value) {
      ...
      if (result) {
        (0, self.B)(result.children, function(arg) {
          if ("LI" == arg.tagName) {
            self.ud(arg, {
              role : "menuitem"
            });
        ...
        var id = result.id;
        if (!id) {
          id = "aria-menu-id-" + self.Fa(result);
          result.id = id;
        }
    ...
    var onClick = function(node, value, id) {
      ...
      if (n) {
        if (self.kq(value, $(node, "checked"))) {
          if (node = self.Zd(id, "LI")) {
            if (node = self.J("yt-ui-menu-item-checked-hid", node)) {
              n = self.rd("yt-ui-menu-item-checked", n);
              (0, self.B)(n, function(onComplete) {
                self.oq(onComplete, "yt-ui-menu-item-checked", "yt-ui-menu-item-checked-hid");
              });
              self.oq(node, "yt-ui-menu-item-checked-hid", "yt-ui-menu-item-checked");
            }
          }
        }
      }
    ...
    var reject = function(obj, value) {
      ...
      return json ? !self.kq(json, $(obj, "content-hidden")) : false;
    };
    /**
     * @param {Text} index
     * @return {undefined}
    ...
    var list = function(index) {
      index = self.qd(window.document, "UL", null, index);
      (0, self.B)(index, function(el) {
        /** @type {number} */
        el.tabIndex = 0;
        var suiteView = classNameToAdd.getInstance();
        self.lq(el, [$(suiteView), $(suiteView, "list")]);
      });
    };
    /**
     * @param {Object} obj
    ...
    var mixin = function(obj, properties) {
      var value = self.bF(properties, "menu-content-id");
      return value && (value = self.pd(value)) ? (self.lq(value, [$(obj, "content"), $(obj, "content-external")]), value) : properties == obj.l ? obj.g : self.J($(obj, "content"), properties);
    };
    /**
     * @param {Object} parent
    ...
    var check = function(parent, arg) {
      var index = self.Fa(arg).toString();
      var frame = parent.C[index];
      if (!frame) {
        frame = self.Ed("IFRAME");
        /** @type {string} */
        frame.src = 'javascript:""';
        /** @type {Array} */
        var meta = [$(parent, "mask")];
        (0, self.B)(self.jq(arg), function(a) {
          meta.push(a + "-mask");
        });
        self.lq(frame, meta);
    ...
    var X = function(m, Var, T, compute, t, x) {
      ...
      /** @type {null} */
      this.D = null;
      this.o = self.J("yt-dialog-fg", this.g) || this.g;
      if (m = self.J("yt-dialog-title", this.o)) {
        var idx = "yt-dialog-title-" + self.Fa(this.o);
        m.setAttribute("id", idx);
        this.o.setAttribute("aria-labelledby", idx);
      }
      this.o.setAttribute("tabindex", "-1");
      this.I = self.J("yt-dialog-focus-trap", this.g);
      /** @type {boolean} */
      this.J = false;
      this.A = new self.XC;
      /** @type {Array} */
      this.F = [];
      this.F.push(self.AF(this.g, "click", (0, self.z)(this.YQ, this), "yt-dialog-dismiss"));
      this.F.push(self.rF(this.I, "focus", (0, self.z)(this.CJ, this), true));
      step(this);
      /** @type {string} */
      this.K = Var;
      /** @type {string} */
     ...
     */
    var step = function(b) {
      b = self.J("yt-dialog-fg-content", b.g);
      /** @type {Array} */
      var headers = [];
      self.Lb(which, function(value) {
        headers.push("yt-dialog-show-" + value);
      });
      self.nq(b, headers);
      self.S(b, "yt-dialog-show-content");
    };
    /**
     * @return {?}
     */
    var fadeOut = function() {
      var r20 = self.rd("yt-dialog");
      return(0, self.Bj)(r20, function(next_callback) {
    ...
    var preload = function(e) {
      var iframe = self.qd(window.document, "iframe", null, e.g);
      (0, self.B)(iframe, function(img) {
        var image = self.bF(img, "onload");
        if (image) {
          if (image = self.x(image)) {
            self.rF(img, "load", image);
          }
        }
        if (image = self.bF(img, "src")) {
          img.src = image;
        }
      }, e);
      return self.Ya(iframe);
    };
    /**
    ...
    var attach = function(context) {
      (0, self.B)(window.document.getElementsByTagName("iframe"), function(j) {
        if (-1 == (0, self.Pa)(context, j)) {
          self.S(j, "iframe-hid");
        }
      });
    };
    ...
    var dismiss = function() {
      var r20 = self.rd("iframe-hid");
      (0, self.B)(r20, function(onComplete) {
        self.mq(onComplete, "iframe-hid");
      });
    };
    /**
     * @param {?} value
    ...
    var updateTemp = function(exports) {
      if (!exports.A) {
        exports.A = self.UF("yt-uix-overlay-hide", funcToCall);
      }
      if (exports.g) {
    ...
    var transform = function(properties, str) {
      var result;
      if (properties) {
        if (result = self.J("yt-dialog", properties)) {
          var results = self.pd("body-container");
          if (results) {
    ...
    var promote = function() {
      var t = r.getInstance();
      if (t.o) {
        t = self.J("yt-dialog-fg-content", t.o.overlayContentNode);
      } else {
        a: {
          if (t = self.rd("yt-dialog-fg-content")) {
            /** @type {number} */
            var i = 0;
            for (;i < t.length;i++) {
              var restoreScript = self.$d(t[i], "yt-dialog");
    ...
    var contains = function(parent, name, child) {
      ...
      if (parent = self.pd(parent)) {
        self.Sd(parent, child);
      }
    };
    /**
     * @param {Object} selector
    ...
    var createElement = function(target, elem) {
      if (elem) {
        ...
        if (c) {
          var node = self.pd(require(target, elem));
          if (!node) {
            node = window.document.createElement("div");
            ...
            path = self.hF() || window.document.body;
            path.appendChild(d);
            ...
            if (c = (0, window.parseInt)(target.Ba(elem, "tooltip-max-width"), 10)) {
              if (t.offsetWidth > c) {
                /** @type {string} */
                t.style.width = c + "px";
                self.S(el, $(target, "normal-wrap"));
              }
            }
            el = self.kq(elem, $(target, "reverse"));
    ...
    var drag = function(e, id, data, event, el, ev) {
      ...
      var b = self.Kh(id);
      ev = new self.hd((b.width - 10) / 2, ev ? b.height : 0);
      var monitor = self.Ch(id);
      resize(new self.hd(monitor.x + ev.x, monitor.y + ev.y), data, h);
      monitor = self.wd(window);
      var a = self.Gh(data);
      data = self.Kh(event);
      /** @type {number} */
    ...
    var createFrame = function(object, name) {
      ...
      var node = null;
      if (self.K0) {
        if (self.kq(name, $(object, "masked"))) {
          if (node = self.pd("yt-uix-tooltip-shared-mask")) {
    ...
    var ready = function(wait) {
      var node = self.pd("yt-uix-tooltip-shared-mask");
      var p = node && self.Yd(node, function(dataAndEvents) {
    ...
    var css = function(properties) {
      properties = self.$d(properties, "yt-uix-button-subscription-container");
      properties = self.J("unsubscribe-confirmation-overlay-container", properties);
      return self.J("yt-dialog", properties);
    };
    /**
     * @param {string} el
     * @param {?} title
    ...
    var display = function(el, title) {
      ...
      var arg = promote();
      return new self.Yf(function($sanitize) {
        matched.push(self.AF(arg, "click", function() {
          $sanitize();
    ...
    var setter = function(list, arg) {
      ...
      self.U(arg, elm.vG + name, !forward);
      self.U(arg, fullname, forward);
      if (list.Ba(arg, settings.IG)) {
        if (!list.Ba(arg, settings.HG)) {
          name = $(old.getInstance());
          self.U(arg, name, !forward);
    ...
    var increment = function(a, value) {
      var r20 = self.rd($(a));
      return(0, self.Ld)(r20, function(isXML) {
    ...
    var on = function(fn, type) {
      var matched = (0, self.z)(function(store) {
        if (store.discoverable_subscriptions) {
          self.QD("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS", store.discoverable_subscriptions);
        }
        this.kw(type);
      }, fn);
      self.Osa(matched, "subscribe", "sub_button");
    };
    /**
     * @param {?} elm
     * @param {?} eventName
     ...
     * @return {?}
     */
    self.h.getHours = function() {
      return this.date.getHours();
    };
    /**
     * @return {?}
     */
    self.h.getMinutes = function() {
      return this.date.getMinutes();
    };
    /**
     * @return {?}
     */
    self.h.getSeconds = function() {
      return this.date.getSeconds();
    };
    /**
     * @return {?}
     */
    self.h.getMilliseconds = function() {
      return this.date.getMilliseconds();
    };
    /**
     * @return {?}
     */
    self.h.getUTCHours = function() {
      return this.date.getUTCHours();
    };
    /**
     * @return {?}
     */
    self.h.getUTCMinutes = function() {
     ...
     * @return {undefined}
     */
    self.h.add = function(interval) {
      self.ko.prototype.add.call(this, interval);
      if (interval.hours) {
     ...
     * @return {?}
     */
    self.h.xo = function(protoProps) {
      var child = self.ko.prototype.xo.call(this, protoProps);
      return protoProps ? child + " " + self.yb(this.getHours(), 2) + ":" + self.yb(this.getMinutes(), 2) + ":" + self.yb(this.getSeconds(), 2) : child + "T" + self.yb(this.getHours(), 2) + self.yb(this.getMinutes(), 2) + self.yb(this.getSeconds(), 2);
    };
    /**
     * @return {?}
     */
    self.h.toString = function() {
      return this.xo();
    };
    /**
     * @return {?}
     */
    self.h.clone = function() {
    ...
    self.h.play = function(options) {
      ...
      pause(this);
      this.startTime = options = (0, self.F)();
      if (-1 == this.g) {
     ...
     * @return {undefined}
     */
    self.h.Ge = function(type) {
      this.dispatchEvent(new tail(type, this));
    };
    self.A(results, p);
    results.prototype.o = self.y;
    /**
     * @return {undefined}
     */
     ...
     * @return {undefined}
     */
    self.h.addEventListener = function(funcToCall, millis, type, ev) {
      self.pf(this.El, funcToCall, millis, type, ev);
    };
    /**
     ...
     * @return {undefined}
     */
    self.h.removeEventListener = function(listener, millis, callback, cb) {
      self.xf(this.El, listener, millis, callback, cb);
    };
    /**
     * @return {undefined}
     */
    ...
    /** @type {Array} */
    var table = [2, 2, 6, 6, 0];
    self.h = options.prototype;
    /**
     * @return {?}
     */
    self.h.clear = function() {
      /** @type {number} */
      this.rb.length = 0;
      /** @type {number} */
      this.Ka.length = 0;
     ...
     * @return {?}
     */
    self.h.moveTo = function(errorCallback, y) {
      if (0 == self.Ka(this.rb)) {
        this.Ce.length -= 2;
      } else {
        this.rb.push(0);
        this.Ka.push(1);
     ...
     * @return {undefined}
     */
    self.h.Ec = function(pos) {
      var i = self.Ka(this.rb);
      if (null == i) {
     ...
     * @return {?}
     */
    self.h.close = function() {
      var rb = self.Ka(this.rb);
      if (null == rb) {
    ...
    value.prototype.Hj = function() {
      return this.Re ? self.Kh(this.la()) : self.ua(this.width) && self.ua(this.height) ? new self.I(this.width, this.height) : null;
    };
    /**
     * @return {undefined}
     */
    ...
    self.A(t, oldconfig);
    self.A(failureMessage, oldconfig);
    self.A(defs, elem);
    /**
     * @return {undefined}
     */
     ...
     * @return {undefined}
     */
    self.h.setSize = function(width, size) {
      self.Jh(this.la(), width, size);
    };
    /**
     * @return {?}
     */
    self.h.Hj = function() {
      if (!self.rh) {
        return this.Re ? self.Kh(this.la()) : QUnit.ba.Hj.call(this);
      }
      var width = this.width;
      var height = this.height;
      var program = self.u(width) && -1 != width.indexOf("%");
      var inverse = self.u(height) && -1 != height.indexOf("%");
      if (!this.Re && (program || inverse)) {
        return null;
      }
      if (program) {
        var parent = this.la().parentNode;
        var parentSize = self.Kh(parent);
        /** @type {number} */
        width = (0, window.parseFloat)(width) * parentSize.width / 100;
      }
      if (inverse) {
        parent = parent || this.la().parentNode;
        parentSize = parentSize || self.Kh(parent);
        /** @type {number} */
        height = (0, window.parseFloat)(height) * parentSize.height / 100;
      }
      return new self.I(width, height);
    };
    /**
     * @return {undefined}
     */
    ...
    self.q(Class, self.sV);
    self.h = Class.prototype;
    /**
     * @return {undefined}
     */
    self.h.load = function() {
      self.sV.prototype.load.call(this);
      if (!runLoggingCallbacks(self.Y(this.g).playerStyle)) {
        ...
        if (opts = opts.cj ? null : opts.qb && (opts.qb.endscreen && opts.qb.endscreen.endscreenRenderer) || null) {
          ...
          opts = {
            method : "POST",
            wd : (0, self.z)(this.FR, this, opts),
            ad : {
              v : opts
            },
            withCredentials : true
          };
          if ("gaming" == self.Y(this.g).playerStyle) {
            /** @type {string} */
            opts.ad.gaming = "1";
          }
          if (this.M) {
          ...
          if (node = self.LO(node)) {
            if (node = self.Mc(node), node = self.Jc(node)) {
              this.B = self.nE(node, opts);
            }
          }
        }
      }
    ...
    self.h.unload = function() {
      ...
      self.sV.prototype.unload.call(this);
    };
    /**
     ...
     * @return {?}
     */
    self.h.CM = function(dataAndEvents, cb) {
      if (!runLoggingCallbacks(self.Y(this.g).playerStyle)) {
        return null;
      }
     ...
     */
    self.h.DM = function() {
      return runLoggingCallbacks(self.Y(this.g).playerStyle) ? ["loadCustomEndscreenRenderer"] : [];
    };
    /**
     * @param {?} dataAndEvents
     * @param {Object} xhr
     * @return {undefined}
     */
    self.h.FR = function(dataAndEvents, xhr) {
      /** @type {null} */
      ...
      if (this.o && this.o.elements) {
        ...
        if (rect && (0 != rect.width && 0 != rect.height)) {
          ...
          if (cell && (0 != cell.width && 0 != cell.height)) {
            ...
            val = properties[p];
            if (this.A) {
              self.ph(this.A.element, "outline-width", Math.max(cell.width, cell.height) + "px");
            }
            /** @type {number} */
            cell = 0;
            for (;cell < this.o.elements.length;++cell) {
              if (i = this.o.elements[cell].id, p = this.l[i], o = this.F[i], p && o) {
                ...
                self.Jh(p.element, Math.round(o.width * rect.width), i);
                self.wh(p.element, funcToCall, millis);
                self.nq(p.element, testError);
                funcToCall = o.left + o.width / 2;
                o = o.top + h / 2;
                self.S(p.element, 0.5 >= funcToCall && 0.5 >= o ? "ytp-ce-top-left-quad" : 0.5 < funcToCall && 0.5 >= o ? "ytp-ce-top-right-quad" : 0.5 >= funcToCall && 0.5 < o ? "ytp-ce-bottom-left-quad" : "ytp-ce-bottom-right-quad");
                self.nq(p.element, properties);
                self.S(p.element, val);
                if (p = self.qd(window.document, "div", "ytp-ce-expanding-overlay-body", p.element)[0]) {
                  self.ph(p, "height", i + "px");
                }
              }
            }
          }
      ...
      if (this.o) {
        if ("ytp-ce-in-endscreen" == path.getId()) {
          ...
          if (!this.J) {
            ...
            var q = this.F[path];
            self.S(info.element, "ytp-ce-element-show");
            info.element.removeAttribute("aria-hidden");
            info = this.g.getRootNode();
            self.S(info, "ytp-ce-shown");
     ...
     * @return {undefined}
     */
    self.h.RU = function(ev) {
      var src = this;
      if (ev.target === window) {
        (new self.Yt(function() {
          var i;
          for (i in src.l) {
            self.nq(src.l[i].element, ["ytp-ce-force-expand", "ytp-ce-element-hover", "ytp-ce-element-shadow-show"]);
          }
        }, 0)).start();
      }
    };
     ...
     * @return {undefined}
     */
    self.h.HC = function(r, event) {
      if (r.targetUrl && (!event || ("keypress" != event.type || 13 == event.keyCode))) {
        var t = event.target;
        for (;t && !self.kq(t, "ytp-ce-element");) {
          if (self.kq(t, "subscribe-label")) {
            swap(this, r);
          }
          if (self.kq(t, "ytp-ce-channel-subscribe")) {
            return;
          }
          t = self.Pd(t);
        }
        if (!t || self.kq(t, "ytp-ce-element-hover")) {
          event.preventDefault();
          event.stopPropagation();
          if (t = this.l[r.id]) {
            this.Ru(t, r);
          ...
          if (event.ctrlKey || (event.metaKey || "new" == r.mq)) {
            ...
            this.aE();
            this.g.hd();
            t = self.Mc(r.targetUrl);
            t = self.Jc(t);
            self.vV(t, void 0, r.Rd);
          } else {
            t = (0, self.z)(this.aE, this, self.Ga(self.uV, r.targetUrl, r.Rd));
            swap(this, r, t);
          }
        }
      }
     ...
     * @return {undefined}
     */
    self.h.Ut = function(arg, obj) {
      if (!self.kq(arg.element, "ytp-ce-element-hover")) {
        if ("VIDEO" == obj.type || "PLAYLIST" == obj.type) {
          self.S(arg.element, "ytp-ce-element-hover");
        } else {
          if (self.Y(this.g).l) {
            (new self.Yt(function() {
              self.S(arg.element, "ytp-ce-element-hover");
     ...
     * @return {undefined}
     */
    self.h.Ru = function(item, obj) {
      self.mq(item.element, "ytp-ce-element-hover");
      self.mq(item.element, "ytp-ce-force-expand");
      sendMessage(this, obj.id, false);
    };
    /**
     * @param {?} code
    ...
    Node.prototype.A = function(a, b, d, mod) {
      this.g[a] = b ? !d : d;
      a = self.Ob(this.g, function(dataAndEvents) {
        return dataAndEvents;
      });
      if (this.o != a) {
        /** @type {Function} */
      ...
      if (c) {
        ...
        if (!(0 >= d.width || 0 >= d.height)) {
          ...
          if (node = (c = (c = color(a)) && c.g ? c.g : null) && c.length ? c[0] : null) {
            var data = self.gh(map(obj, action(node, new self.bh(node.F, node.H, node.Qk, node.o), obj.g)));
            var b = d.clone();
            c = new self.bh(data.x, data.y, 1, 1);
            /** @type {number} */
            ...
            d = new self.bh(d.left - b.left, d.top - b.top, d.width, d.height);
            var e = new self.hd(data.x - b.left, data.y - b.top);
            /** @type {number} */
            ...
            test(next, me, data, m);
            if (m = this.la()) {
              self.S(m, "annotation-shape");
              self.S(m, "annotation-speech-shape");
              self.wh(m, b.left, b.top);
              self.Jh(m, b.width, b.height);
    ...
    wrapper.prototype.C = function(a, b, o, r) {
      ...
      function within(c, start, a, p) {
        ...
        start = self.dd(start - c / 2, a + b, a + p - c - b);
    ...
    def.prototype.o = function(a, b) {
      ...
      if (result) {
        ...
        if (!(0 >= item.width || 0 >= item.height)) {
          ...
          var source = new self.bh(0, 0, item.width, item.height);
          ...
          bind = this.la();
          self.S(bind, "annotation-shape");
          g = g.g;
          self.Mh(bind, this.g ? Math.max(g, 0.9) : g);
          self.wh(bind, result.left, result.top);
          self.Jh(bind, result.width, result.height);
        }
      }
    };
    self.q(copy, block);
    ...
    copy.prototype.o = function(a, b) {
      ...
      if (c) {
        ...
        if (!(0 >= item.width || 0 >= item.height)) {
          ...
          var result = new self.bh(0, 0, item.width, item.height);
          ...
          if (result = this.la()) {
            self.S(result, "annotation-shape");
            self.S(result, "annotation-popup-shape");
            self.wh(result, node.left, node.top);
            self.Jh(result, node.width, node.height);
            setup(obj, result, c.effects);
          }
        }
      }
    };
    self.q(report, wrapper);
    /**
     * @param {Function} a
     * @param {?} b
     * @param {?} o
    ...
    self.h.AB = function() {
      if (!this.H) {
        ...
        if (this.o) {
          /** @type {boolean} */
          this.o.g = true;
          self.Mh(this.l, updateGraph(this) ? 1 : 0);
        ...
        /** @type {boolean} */
        this.H = true;
        this.I = this.W.xh(self.VU(this.C), "mouseleave", function(variables) {
          this.wp.stop();
          this.Ih(variables);
        });
      }
    ...
    self.h.JO = function() {
      var original = this.Y;
      var core_rnotwhite = new self.hd(original.clientX, original.clientY);
      var options = self.Ch(this.C.getRootNode());
      var value = scroll(options, this.K);
      options = (this.B && self.Nh(this.B) || this.A && self.Nh(this.A)) && scroll(options, this.M);
    ...
    self.h.show = function() {
      ...
      if (obj) {
        ...
        if (o) {
          if (o.o(this.g, properties), this.o = o, properties = o.la()) {
            self.O(properties, false);
            self.S(properties, "annotation-type-" + this.g.type.toLowerCase());
            this.X(properties);
          }
        }
      }
      if (array) {
        ...
        this.l = self.K("DIV", properties);
        self.O(this.l, false);
        if (this.g.A) {
          this.D = self.K("DIV", "inner-text");
          if ("label" == this.g.style) {
            self.S(this.D, "label-text");
            this.D.style.backgroundColor = this.g.l.bgColor;
          }
          self.Sd(this.D, this.g.A);
          this.l.appendChild(this.D);
        }
        self.aF(this.l, "annotation_id", this.g.id);
        this.X(this.l);
        bindEvents(this, this.l);
        if (eq(this.g) && this.g.showLinkIcon()) {
          if (o = this.g.Ta()) {
            properties = this.l;
            o = new self.vm(parseFloat(o));
            properties.title = o.l + o.o;
          }
          this.B = self.K("SPAN", "annotation-link-icon");
          self.O(this.B, false);
      ...
      if (widget) {
        if ("subscribe" == this.g.style) {
          self.J("yt-uix-subscription-button", this.l);
        }
      }
      if (obj || array) {
        a: {
     ...
     * @return {undefined}
     */
    self.h.hide = function() {
      if (this.l) {
        self.O(this.l, false);
      }
      if (this.o) {
        if (this.o.la()) {
          self.O(this.o.la(), false);
        }
      }
      if (this.J) {
        this.W.Ea(this.J);
    ...
    self.q(Cursor, self.M);
    self.h = Cursor.prototype;
    /**
     * @return {undefined}
     */
    self.h.hide = function() {
    ...
    self.q(initialize, Entity);
    self.q(process, Entity);
    self.q(publish, process);
    self.q(play, Entity);
    self.q(done, Entity);
    self.q(last, process);
    self.q(all, process);
    self.q(onSuccess, Entity);
    self.q(handle, Entity);
    /**
     * @param {Function} a
     * @param {?} b
     * @return {undefined}
    ...
    Matrix.prototype.o = function(a, b) {
      var m = self.Zd(b.target, "label");
      if (m) {
        self.U(m, "iv-card-poll-choice-focused", a);
      }
    };
    /**
     * @param {Function} a
    ...
    Matrix.prototype.D = function(a, b) {
      var oldconfig = self.$d(b.target, "iv-card-poll");
      if (oldconfig) {
        if (a.A) {
          self.J("iv-card-sign-in-button", oldconfig).click();
        } else {
    ...
    Matrix.prototype.C = function(a) {
      var updateGGA = self.x("yt.www.ypc.bootstrap.api.loadOffersForInnertubeRequestParams");
      var QUnit;
      if (updateGGA) {
        /**
         * @return {undefined}
    ...
    Matrix.prototype.F = function(a) {
      var ok = self.x("yt.www.ypc.bootstrap.api.loadOffers");
      if (ok) {
        ok = self.Ga(ok, a.K, a.H, a.B);
      }
     ...
     * @return {undefined}
     */
    self.h.Zi = function(statements, value, millis, a3, error, opt_attributes, keepData) {
      this.context.g.U(statements, "click", self.Ga(this.Uo, value, millis, a3, error, opt_attributes || [], keepData || 0), this);
      this.context.g.U(statements, "touchstart", self.Ga(function() {
        /** @type {boolean} */
        this.Yv = false;
      }), this);
      this.context.g.U(statements, "touchmove", self.Ga(function() {
        /** @type {boolean} */
        this.Yv = true;
      }), this);
    };
     ...
     * @return {?}
     */
    self.h.Uo = function(data, dataAndEvents, _super, config, deepDataAndEvents, isXML, event) {
      if (this.Yv) {
        return false;
      }
      if (event) {
    ...
    self.q(loop, g);
    self.h = loop.prototype;
    /**
     * @return {?}
     */
    self.h.isAvailable = function() {
      var conf;
    ...
    self.h.Fn = function() {
      ...
      self.O(this.la(), errorCallback);
      self.U(this.context.l.getRootNode(), "ytp-iv-drawer-enabled", errorCallback);
      isFunction(this.g);
    };
    /**
     * @return {undefined}
     ...
     * @return {undefined}
     */
    self.h.kE = function(e) {
      if (!self.kq(this.g.getRootNode(), "ytp-cards-teaser-shown")) {
        if (this.l != e) {
          this.l = e;
          trim(this);
        }
     ...
     */
    self.h.qJ = function() {
      self.U(this.D, "iv-drawer-scrolled", 0 < this.A.scrollTop);
    };
    /**
     * @return {undefined}
     */
     ...
     * @return {undefined}
     */
    self.h.UV = function(now, which, onComplete, l2) {
      this.o.stop();
      if (!this.A) {
        var s = self.Kh(now);
        if (!this.g) {
          self.Ih(now, s.width);
          self.Ih(which, s.width);
        }
        self.ph(onComplete, "top", s.height - Math.max(Math.min(s.height, l2) / 2 + 10, 20) + "px");
        self.ph(onComplete, "right", "1px");
        /** @type {boolean} */
        this.A = true;
        self.O(now, true);
        this.B = new self.Yt(function() {
          self.S(this.la(), "iv-branding-active");
        }, 0, this);
        this.B.start();
      }
    };
     ...
     * @return {undefined}
     */
    self.h.JK = function(onComplete, which) {
      self.mq(this.la(), "iv-branding-active");
      this.C = new self.Yt((0, self.z)(function() {
        self.O(onComplete, false);
        if (!this.g) {
          self.Ih(which, 0);
        }
      }, this), 250);
    ...
    self.h.show = function() {
      if (!this.isActive) {
        ...
        if (!this.D) {
          ...
          self.O(this.l, false);
          var elem = self.K("DIV", "branding-img-container", this.l);
          this.la().appendChild(elem);
          var index = self.K("DIV", "iv-branding-context-name");
          self.Sd(index, options.channel_name);
          var node = self.K("DIV", "iv-branding-context-subscribe");
          if (elem = options.standalone_subscribe_button_data) {
            this.g = new self.y_(elem.subscribeText, elem.subscribeCount, elem.unsubscribeText, elem.unsubscribeCount, !!elem.enabled, !!elem.classic, options.channel_id, !!elem.subscribed, elem.feature, options.session_data.itct, elem.signinUrl, this.H.l);
            this.g.ua(node);
          }
          elem = self.K("DIV", "iv-branding-context-subscribe-caret");
          index = self.K("DIV", "branding-context-container-inner", elem, index, node);
          self.O(index, false);
          node = self.K("DIV", "branding-context-container-outer", index);
          self.ph(node, "right", this.F + "px");
          ...
          this.o = new self.Yt(self.Ga(this.JK, index, node), 500, this);
          self.N(this, this.o);
          this.context.g.U(this.la(), "mouseover", (0, self.z)(this.UV, this, index, node, elem, options.image_height));
          this.context.g.U(this.la(), "mouseout", (0, self.z)(this.o.start, this.o, void 0));
          /** @type {boolean} */
          this.D = true;
        }
        ...
        if (this.l) {
          ...
          elem = self.Lh(options).width;
          index = self.ua(void 0) ? void 0 : elem;
          self.wh(options, index);
          oldconfig = new base(options, [index, options.offsetTop], [index - elem - oldconfig, options.offsetTop], 200, easeIn);
          self.N(this, oldconfig);
          this.context.A.U(oldconfig, "begin", self.Ga(self.O, options, true));
          oldconfig.play();
        }
      }
    };
    ...
    self.h.show = function() {
      if (!this.isActive) {
        ...
        self.tg(function() {
          self.mq(this.la(), "iv-promo-inactive");
        }, 100, this);
    ...
    self.h.hide = function() {
      if (this.isActive) {
        self.S(this.la(), "iv-promo-inactive");
        /** @type {boolean} */
        this.isActive = false;
     ...
     * @return {?}
     */
    self.h.Uo = function(mapper, graphics, capture, opt_coordHeight, opt_acc, opt_domHelper, borderColor) {
     ...
     * @return {undefined}
     */
    self.h.ys = function(prop, deepDataAndEvents) {
     ...
     * @return {undefined}
     */
    self.h.fK = function(deepDataAndEvents) {
      /** @type {boolean} */
      this.H = true;
     ...
     * @return {undefined}
     */
    self.h.LO = function(dataAndEvents) {
     ...
     * @return {undefined}
     */
    self.h.UJ = function(dataAndEvents) {
      dataAndEvents.stopPropagation();
      isWindow(this);
      /** @type {boolean} */
      this.B = true;
      self.S(this.la(), "iv-promo-collapsed-no-delay");
      this.C.start();
      e(this.context.logger, this.annotation.g);
    };
    /**
    ...
    self.q(run, self.sV);
    self.h = run.prototype;
    /**
     * @param {?} dataAndEvents
     * @param {Object} lng
     * @return {?}
     */
    self.h.wM = function(dataAndEvents, lng) {
      if (!objEquiv(self.Y(this.g).playerStyle)) {
        return null;
      }
      switch(dataAndEvents) {
        case "loadCustomAnnotationsXml":
          var basePrototype = self.Vr(lng);
          if (basePrototype) {
     ...
     */
    self.h.xM = function() {
      return objEquiv(self.Y(this.g).playerStyle) ? ["loadCustomAnnotationsXml", "removeCustomAnnotationById"] : [];
    };
    /**
     * @return {undefined}
     */
    self.h.Tu = function() {
      if (this.C) {
        var s = self.W_(self.VU(this.g), true);
        self.Jh(this.C.element, s.width, s.height);
        self.wh(this.C.element, s.left, s.top);
      }
      if (this.l) {
        var column = self.eV(this.g);
        s = this.l;
        column = column.width;
        self.U(s.D, "iv-drawer-small", 426 >= column);
        self.U(s.D, "iv-drawer-big", 1280 <= column);
      }
    };
    /**
     * @param {Object} defer
     * @return {undefined}
     */
    self.h.fT = function(defer) {
      if (!self.Y(this.g).experiments.g("web_player_update_annotations_module_visibility_killswitch")) {
        this.Pc(defer.state);
      }
      if (self.X(defer.state, 2)) {
        if (this.Vl()) {
          if (this.WA()) {
            if (2 != this.g.Qa()) {
              this.Tt(false);
    ...
    self.h.load = function() {
      ...
      if (self.Y(this.g).experiments.g("web_player_update_annotations_module_visibility_killswitch")) {
        ...
        this.Pc(self.UU(this.g));
      }
      this.I++;
      var event = this.g.getVideoData();
      var cur = event.videoId;
      var options = (0, self.z)(this.JR, this, cur, this.I);
      var item = (0, self.z)(function() {
        /** @type {null} */
        this.D = null;
      }, this);
      if (self.nG()) {
      ...
      if (!event.xn || cur) {
        if (event.Of) {
          ...
          this.B = (0, self.z)(this.BM, this, options);
          this.g.addEventListener("videodatachange", this.B);
        }
      }
      self.mV(this.g, this.C.element, 4);
      this.Tu();
    };
    /**
     * @param {boolean} left
     * @return {undefined}
     */
    self.h.Pc = function(left) {
      /** @type {boolean} */
      left = !self.xP(left) && !self.X(left, 1024);
      self.sH(this.A, left);
      self.sH(this.C, left);
    };
    /**
    ...
    self.h.unload = function() {
      ...
      self.kV(this.g, "annotations_module");
      self.Lb(this.o, function(todo) {
        todo.destroy();
      });
      self.Lb(this.K, function(todo) {
        todo.destroy();
      });
      /** @type {null} */
      this.H = null;
     ...
     * @return {undefined}
     */
    self.h.JR = function(res, parser, data) {
      /** @type {null} */
      this.D = null;
      if (!node(this, parser, res) && (res = self.WD(data) && data.responseXML ? data.responseXML : null)) {
        go(this, res);
        self.S(this.g.getRootNode(), "iv-module-loaded");
        /** @type {Array} */
        res = [];
        var i;
        for (i in this.o) {
          ...
          if (m = data) {
            if (data = 1E3 * m.start, m = 1E3 * m.end, 0 == data && (data++, m++), !(m < data)) {
              ...
              parser = new self.eQ(data, m, opts);
              res.push(parser);
            }
          }
        }
     ...
     * @return {undefined}
     */
    self.h.lD = function(dataAndEvents) {
     ...
     * @return {undefined}
     */
    self.h.vQ = function(data) {
      if (data && data.id) {
        var e = data.Ta();
        if (e) {
          var value = parseFloat(e);
          if (value) {
            var response = (0, self.z)(this.Xn, this, data, "click");
     ...
     * @return {undefined}
     */
    self.h.Xn = function(property, name) {
        ...
        if (node.trigger == name && ("openUrl" == node.type && node.url)) {
          ...
          if (!(data = !fail(this, node.url))) {
            ...
            if (data) {
              if (record.videoId == data) {
                ...
                self.H0(record.app, data, void 0, void 0, void 0, void 0, void 0);
                if (value) {
          ...
          if (data) {
            ...
            if (record = parseFloat(node.url)) {
              ...
              if (data) {
                if ("com" == value[0]) {
                  if ("google" == value[1]) {
                    if ("plus" == value[2]) {
                      data = self.Ga(query, data.pageId, data.Sc);
                      record = new self.vm(record);
                      self.zm(record, data(record.o));
            ...
            if (record) {
              ...
              data = property.itct;
              if ("ei" in self.dE(record)) {
                record = self.Vg(record, "ei");
              }
              self.vV(record, "current" == node ? "_top" : void 0, {
                itct : data
              });
            }
          }
     ...
     * @return {undefined}
     */
    self.h.Tt = function(recurring, type, deepDataAndEvents) {
     ...
     * @return {undefined}
     */
    self.h.St = function(recurring, regex) {
     ...
     */
    self.h.V = function() {
      self.Y(this.g).C.unsubscribe("vast_info_card_add", this.lD, this);
      self.mq(this.g.getRootNode(), "ytp-iv-drawer-open");
      var values = this.M;
      /** @type {number} */
      var i = 0;
      ...
      /** @type {number} */
      this.M.length = 0;
      self.sV.prototype.V.call(this);
    };
    var types = {};
    /** @type {boolean} */
    var isTouchDevice = "ontouchstart" in window.document;
    self.rF(window.document, "blur", bindings, true);
    self.rF(window.document, "change", bindings, true);
    self.rF(window.document, "click", bindings);
    self.rF(window.document, "focus", bindings, true);
    self.rF(window.document, "mouseover", bindings);
    self.rF(window.document, "mouseout", bindings);
    self.rF(window.document, "mousedown", bindings);
    self.rF(window.document, "keydown", bindings);
    self.rF(window.document, "keyup", bindings);
    self.rF(window.document, "keypress", bindings);
    self.rF(window.document, "cut", bindings);
    self.rF(window.document, "paste", bindings);
    if (isTouchDevice) {
      self.rF(window.document, "touchstart", bindings);
      self.rF(window.document, "touchend", bindings);
      self.rF(window.document, "touchcancel", bindings);
    }
    self.h = assert.prototype;
    /**
     * @param {Object} str
     * @return {?}
     */
    self.h.pe = function(str) {
      return self.$d(str, $(this));
    };
    /**
     * @return {undefined}
     */
    self.h.unregister = function() {
      self.VF(this.H);
      /** @type {number} */
      this.H.length = 0;
      self.HN(this.F);
     ...
     * @return {undefined}
     */
    self.h.addBehavior = function(type, property, name) {
      name = $(this, name);
      var prefixed = (0, self.z)(property, this);
      if (!(type in types)) {
        types[type] = new self.XC;
      }
     ...
     * @return {undefined}
     */
    self.h.removeBehavior = function(type, id, name) {
      if (type in types) {
        var self = types[type];
     ...
     * @return {undefined}
     */
    self.h.qj = function(value, storageKey, keepData) {
      var block = this.Ba(value, storageKey);
      if (block && (block = self.x(block))) {
        var args = self.$a(arguments, 2);
        self.ab(args, 0, 0, value);
     ...
     * @return {?}
     */
    self.h.Ba = function(value, key) {
      return self.bF(value, key);
    };
    /**
     * @param {?} name
     * @param {string} funcToCall
     ...
     * @return {undefined}
     */
    self.h.setData = function(name, funcToCall, value) {
      self.aF(name, funcToCall, value);
    };
    self.A(resp, assert);
    self.ya(resp);
    self.h = resp.prototype;
    /**
     * @return {undefined}
     */
    self.h.register = function() {
     ...
     * @return {undefined}
     */
    self.h.sA = function(data, node, e) {
      if (!(e.altKey || (e.ctrlKey || (e.shiftKey || e.metaKey))) && (node = spawn(this, data))) {
        ...
        if (child) {
          ...
          if (r20) {
            save(this, data, node, e, (0, self.z)(r20, this));
          }
        }
      }
    };
    ...
    self.h.hK = function() {
      ...
      if (0 != self.Pb(map)) {
        ...
        for (letter in map) {
          var node = map[letter];
          var origContext = self.$d(node.activeButtonNode || node.parentNode, $(this));
     ...
     * @return {undefined}
     */
    self.h.tA = function(args, dataAndEvents, jqEvent) {
      if (!jqEvent.altKey) {
        if (!jqEvent.ctrlKey) {
          if (!jqEvent.shiftKey) {
            if (!jqEvent.metaKey) {
     ...
     * @return {undefined}
     */
    self.h.hM = function(pattern, data, types) {
      var event = _insert(this, data);
      if (event) {
        data = makeElement("table", data);
        var node = makeElement("tr", data);
        node = self.qd(window.document, "td", null, node).length;
        data = self.qd(window.document, "td", null, data);
     ...
     * @return {undefined}
     */
    self.h.iM = function(pattern, data, e) {
      if (40 == e.keyCode || 38 == e.keyCode) {
        var event = _insert(this, data);
        if (event) {
          data = (0, self.Ld)(self.qd(window.document, "li", null, data), unbind);
    ...
    self.h.dG = function(context) {
      if (context) {
        ...
        if (node) {
          ...
          self.YF("yt-uix-button-menu-before-show", context, node);
          removeClass(node);
          if (item) {
            removeClass(item);
          }
          this.qj(context, "button-menu-action", true);
          self.S(context, $(this, "active"));
          node = (0, self.z)(this.cG, this, context, false);
          item = (0, self.z)(this.cG, this, context, true);
          ret = (0, self.z)(this.wW, this, context, void 0);
          if (!(this.g && spawn(this, this.g) == spawn(this, context))) {
            refresh(this);
          }
          self.XF("yt-uix-button-menu-show", context);
          self.sF(this.o);
          /** @type {Array} */
          this.o = [self.rF(window.document, "click", item), self.rF(window.document, "contextmenu", node), self.rF(window, "resize", ret)];
          /** @type {Element} */
          this.g = context;
        }
      }
     ...
     * @return {undefined}
     */
    self.h.wW = function(x, data) {
      var c = spawn(this, x);
      if (c) {
        if (data) {
          if (data instanceof self.Uc) {
            c.innerHTML = self.Vc(data);
          } else {
            self.Sd(c, data);
          }
        }
     ...
     */
    self.h.cd = function() {
      return self.J($(this, "content"), void 0);
    };
    /**
     * @param {?} properties
     * @param {?} dataAndEvents
     ...
     * @return {undefined}
     */
    self.h.cG = function(properties, dataAndEvents, v) {
      v = self.tF(v);
      var i = self.$d(v, $(this));
      if (i) {
        i = spawn(this, i);
      ...
      i = self.$d(v, $(this, "menu"));
      /** @type {boolean} */
      last = i == spawn(this, properties);
      var a = self.kq(v, $(this, "menu-item"));
      var b = self.kq(v, $(this, "menu-close"));
      if (!i || last && (a || b)) {
        draw(this, properties);
        if (i) {
          if (dataAndEvents) {
            if (this.Ba(properties, "button-menu-indicate-selected")) {
              if (properties = self.J($(this, "content"), properties)) {
                self.Sd(properties, highlight(v));
              }
     ...
     * @return {?}
     */
    self.h.isToggled = function(onComplete) {
      return self.kq(onComplete, $(this, "toggled"));
    };
    /**
     * @param {Element} element
     * @return {undefined}
     */
    self.h.toggle = function(element) {
      if (this.Ba(element, "button-toggle")) {
        var context = self.$d(element, $(this, "group"));
        var indicator = $(this, "toggled");
        var elementRect = self.kq(element, indicator);
        if (context && this.Ba(context, "button-toggle-group")) {
          var key = this.Ba(context, "button-toggle-group");
          context = self.rd($(this), context);
          (0, self.B)(context, function(context) {
            if (context != element || "optional" == key && elementRect) {
              self.mq(context, indicator);
              context.removeAttribute("aria-pressed");
            } else {
              self.S(element, indicator);
              context.setAttribute("aria-pressed", "true");
            }
          });
        } else {
     ...
     * @return {undefined}
     */
    self.h.click = function(options) {
      if (spawn(this, options)) {
        var node = spawn(this, options);
        if (node) {
          var container = self.$d(node.activeButtonNode || node.parentNode, $(this));
          if (container && container != options) {
            draw(this, container);
            self.XD((0, self.z)(this.dG, this, options), 1);
          } else {
            if (unbind(node)) {
              draw(this, options);
            } else {
    ...
    self.h.Ba = function(value, key) {
      ...
      return result ? result : (result = b.ba.Ba.call(this, value, "card-config")) && ((result = self.x(result)) && result[key]) ? result[key] : null;
    };
    /**
     * @param {Object} name
     * @return {undefined}
     */
    self.h.show = function(name) {
      var collection = this.pe(name);
      if (collection) {
        self.S(collection, $(this, "active"));
        ...
        if (current) {
          ...
          self.XD((0, self.z)(function() {
            if (!e) {
              removeClass(current);
              self.XF("yt-uix-card-show", collection, name, current);
            }
            add(current);
            self.S(current, indicator);
            self.XF("yt-uix-kbd-nav-move-in-to", current);
          }, this), 10);
        }
      }
    };
     ...
     * @return {undefined}
     */
    self.h.hide = function(value) {
      if (value = this.pe(value)) {
        var cell = self.pd($(this, "card") + write(value));
        if (cell) {
          self.mq(value, $(this, "active"));
          self.mq(cell, $(this, "card-visible"));
          addClass(cell);
          /** @type {null} */
          this.o = null;
          /** @type {null} */
    ...
    self.h.uW = function(name, r) {
      ...
      if (arg) {
        if (r) {
          ...
          if (r instanceof self.Uc) {
            me.innerHTML = self.Vc(r);
          } else {
            self.Sd(me, r);
          }
        }
        if (self.kq(arg, $(this, "active"))) {
     ...
     * @return {?}
     */
    self.h.isActive = function(m) {
      return(m = this.pe(m)) ? self.kq(m, $(this, "active")) : false;
    };
    /**
     * @param {?} elem
     * @return {?}
     */
    self.h.Cc = function(elem) {
      var s = elem.cardContentNode;
      if (!s) {
        var ok = $(this, "content");
        var indicator = $(this, "card-content");
        if (!(s = (s = this.Ba(elem, "card-id")) ? self.pd(s) : self.J(ok, elem))) {
    ...
    var bounds;
    self.A(classNameToAdd, assert);
    self.ya(classNameToAdd);
    self.h = classNameToAdd.prototype;
    /**
     * @return {undefined}
     */
    self.h.register = function() {
     ...
     * @return {undefined}
     */
    self.h.Bz = function(input, d, e) {
      var code = e.keyCode;
      if (input = self.$d(input, $(this))) {
        switch(code) {
          case 13:
          ;
          case 32:
          ...
          case 27:
            ...
            a: {
              ...
              for (;!e;) {
                e = self.$d(input.parentElement, $(this));
                if (!e) {
                  break a;
                }
              ...
              e = self.pd(e);
              this.jo(e);
              self.XF("yt-uix-kbd-nav-move-out-done", e);
            }
            break;
          case 40:
          ;
          case 38:
            if ((d = e.target) && self.kq(input, $(this, "list"))) {
              switch(code) {
                case 40:
                  this.hC(d, input);
                  break;
     ...
     * @return {undefined}
     */
    self.h.bQ = function(ctxt) {
      emit(this, self.ae(), ctxt);
      this.jo(ctxt);
    };
    /**
     * @param {Element} element
    ...
    self.h.unregister = function() {
      ...
      /** @type {null} */
      this.l = this.g = null;
      self.sF(each(self.Rb(this.o)));
      this.o = {};
      self.Lb(this.C, function(onComplete) {
        self.Kd(onComplete);
      }, this);
      this.C = {};
      self.$e(this.A);
     ...
     * @return {undefined}
     */
    self.h.eG = function(value, result, opt_e) {
      if (value) {
     ...
     * @return {undefined}
     */
    self.h.cK = function(value, result, opt_e) {
      if (value) {
        if (self.kq(value, $(this, "hover"))) {
          result = resultSelector(this, value);
          if (hasKey(opt_e.target, result)) {
     ...
     * @return {undefined}
     */
    self.h.fG = function(value) {
      if (value) {
        var node = mixin(this, value);
        if (node) {
          self.YF("yt-uix-menu-before-show", value, node);
          if (this.g) {
            ...
            this.l = value;
            this.g = node;
            if (!self.kq(value, $(this, "sibling-content"))) {
              self.Kd(node);
              window.document.body.appendChild(node);
            }
            /** @type {number} */
          ...
          self.mq(node, $(this, "content-hidden"));
          group(this, value, node);
          self.lq(resultSelector(this, value), [$(this, "trigger-selected"), "yt-uix-button-toggled"]);
          self.XF("yt-uix-menu-show", value);
          list(node);
          store(this, value);
          self.XF("yt-uix-kbd-nav-move-in-to", node);
          var a = (0, self.z)(this.vX, this, value);
          var idx = (0, self.z)(this.eM, this, value);
          i = self.Fa(value).toString();
          /** @type {Array} */
          this.o[i] = [self.rF(node, "click", idx), self.rF(window.document, "click", a)];
          if (self.kq(value, $(this, "indicate-selected"))) {
            a = (0, self.z)(this.fM, this, value);
            this.o[i].push(self.rF(node, "click", a));
          }
          if (self.kq(value, $(this, "hover"))) {
            value = (0, self.z)(this.uX, this, value);
            this.o[i].push(self.rF(window.document, "mousemove", value));
          }
        }
      }
    };
     ...
     * @return {undefined}
     */
    self.h.uX = function(value, key) {
      var camelKey = self.tF(key);
      if (camelKey) {
     ...
     * @return {undefined}
     */
    self.h.vX = function(b, parentNode) {
      var id = self.tF(parentNode);
      if (id) {
        if (isPlainObject(this, id)) {
          var a = self.$d(id, $(this, "content"));
          var element = self.Zd(id, "LI");
          if (element) {
            if (a) {
              if (self.Qd(a, element)) {
                self.YF("yt-uix-menu-item-clicked", id);
              }
            }
          }
          id = self.$d(id, $(this, "close-on-select"));
          if (!id) {
            return;
          }
          a = decode(id);
     ...
     * @return {undefined}
     */
    self.h.eM = function(isXML, style) {
      var target = self.tF(style);
      if (target) {
     ...
     * @return {undefined}
     */
    self.h.fM = function(isXML, style) {
      var target = self.tF(style);
      if (target) {
        var properties = resultSelector(this, isXML);
        if (properties && (target = self.Zd(target, "LI"))) {
          if (target = highlight(target).trim(), properties.hasChildNodes()) {
            var html = resp.getInstance();
            if (properties = self.J($(html, "content"), properties)) {
              self.Sd(properties, target);
            }
          } else {
            self.Sd(properties, target);
          }
    ...
    self.h.unregister = function() {
      ...
      for (property in this.g) {
        self.sF(this.g[property]);
      }
      this.g = {};
      for (property in this.l) {
        self.sF(this.l[property]);
      }
      this.l = {};
    };
    /**
     ...
     * @return {undefined}
     */
    self.h.Zx = function(options, data, ev) {
      ev.preventDefault();
      data = self.Zd(ev.target, "button");
      if (!data || !data.disabled) {
        data = this.Ba(options, "card-target");
        var url;
        if (data) {
          url = self.u(data) ? window.document.getElementById(data) : data;
        } else {
          /** @type {Object} */
          url = options;
        }
        ...
        if (!this.Ba(url, "disabled")) {
          if (self.kq(url, $(this, "active"))) {
            this.hide(options);
            self.mq(url, $(this, "active"));
          } else {
            this.show(options);
            self.S(url, $(this, "active"));
          }
        }
      }
    };
     ...
     * @return {undefined}
     */
    self.h.show = function(value) {
      config.ba.show.call(this, value);
      var v = this.pe(value);
      var key = self.Fa(value).toString();
      if (!self.bF(v, "click-outside-persists")) {
        if (this.g[key]) {
          return;
        }
        v = self.rF(window.document, "click", (0, self.z)(this.ay, this, value));
        var spy = self.rF(window, "blur", (0, self.z)(this.ay, this, value));
        /** @type {Array} */
        this.g[key] = [v, spy];
      }
      value = self.rF(window, "resize", (0, self.z)(this.uW, this, value, void 0));
      /** @type {Object} */
      this.l[key] = value;
    };
    /**
     ...
     * @return {undefined}
     */
    self.h.hide = function(name) {
      config.ba.hide.call(this, name);
      name = self.Fa(name).toString();
     ...
     * @return {undefined}
     */
    self.h.ay = function(options, ev) {
      /** @type {string} */
      var funcToCall = "yt-uix" + (this.B ? "-" + this.B : "") + "-card";
      /** @type {null} */
      var thisp = null;
      if (ev.target) {
        thisp = self.$d(ev.target, funcToCall) || self.$d(decode(ev.target), funcToCall);
      }
      if (!(thisp = thisp || (self.$d(window.document.activeElement, funcToCall) || self.$d(decode(window.document.activeElement), funcToCall)))) {
        this.hide(options);
      }
    };
    /**
     ...
     * @return {undefined}
     */
    self.h.Yx = function(elm) {
      if (elm = self.$d(elm, $(this, "card"))) {
    ...
    self.h.cC = function(data) {
      if (model != data) {
        ...
        var state = (0, self.z)(this.show, this, data);
        var value = (0, window.parseInt)(this.Ba(data, "delay-show"), 10);
        state = self.XD(state, -1 < value ? value : 200);
    ...
    self.h.eC = function(options) {
      ...
      self.XD((0, self.z)(this.KK, this, options), title);
     ...
     * @return {undefined}
     */
    self.h.dC = function(dataAndEvents) {
      if (dataAndEvents) {
        /** @type {boolean} */
     ...
     * @return {undefined}
     */
    self.h.fC = function(dataAndEvents) {
      if (dataAndEvents) {
      ...
      if (!this.ka()) {
        ...
        if (!this.M) {
          ...
          if (sh) {
            ...
            if (docEl && t) {
              if (vh = self.wd(vh).height, self.vd(sh) && docEl.scrollHeight) {
        ...
        t = preload(this);
        attach(t);
        this.B = self.rF(window.document, "keydown", (0, self.z)(this.OL, this));
        t = this.g;
        docEl = self.UF("player-added", this.Jz, this);
        self.aF(t, "player-ready-pubsub-key", docEl);
        if (this.T) {
          this.C = self.rF(window.document, "click", (0, self.z)(this.bV, this));
        }
        removeClass(this.g);
        this.o.setAttribute("tabindex", "0");
        focus(this);
        if (!this.H) {
          self.S(window.document.body, "yt-dialog-active");
        }
        refresh(resp.getInstance());
        apply(config.getInstance());
        apply(ret.getInstance());
        self.XF("yt-ui-dialog-show-complete", this);
      }
    };
    /**
     * @return {undefined}
    ...
    self.h.Jz = function() {
      if (!this.X) {
        var g = this.g;
        self.U(window.document.body, "hide-players", true);
        if (g) {
          self.U(g, "preserve-players", true);
        }
      }
    };
    /**
     ...
     * @return {undefined}
     */
    self.h.YQ = function(target) {
      target = target.currentTarget;
      if (!target.disabled) {
        target = self.bF(target, "action") || "";
        this.dismiss(target);
      }
    };
    /**
    ...
    self.h.dismiss = function(event) {
      if (!this.ka()) {
        ...
        if (!fadeOut()) {
          addClass(this.l);
          if (!this.H) {
            self.mq(window.document.body, "yt-dialog-active");
          }
          flush();
          dismiss();
        }
        ...
        var data = this.g;
        if (data) {
          var conf = self.bF(data, "player-ready-pubsub-key");
          if (conf) {
            self.VF(conf);
        ...
        this.A.R("post-all");
        self.XF("yt-ui-dialog-hide-complete", this);
        if ("cancel" == event) {
          self.XF("yt-ui-dialog-cancelled", this);
        }
        if (this.A) {
          this.A.R("post-" + event);
        }
     ...
     * @return {undefined}
     */
    self.h.setTitle = function(funcToCall) {
      self.Sd(self.J("yt-dialog-title", this.g), funcToCall);
    };
    /**
     * @param {Event} event
     * @return {undefined}
     */
    self.h.OL = function(event) {
      self.XD((0, self.z)(function() {
        if (!this.K) {
          if (!(27 != event.keyCode)) {
            this.dismiss("cancel");
      ...
      if (9 == event.keyCode) {
        if (event.shiftKey) {
          if (self.kq(window.document.activeElement, "yt-dialog-fg")) {
            event.preventDefault();
          }
        }
      }
     ...
     * @return {undefined}
     */
    self.h.CJ = function(event) {
      event.stopPropagation();
      focus(this);
    };
    self.va("yt.ui.Dialog", X, void 0);
    self.A(r, assert);
    self.ya(r);
    self.h = r.prototype;
    /**
    ...
    self.h.yv = function(key) {
      if (!this.g || !unbind(this.g.g)) {
        ...
        if (value && key) {
          ...
          this.o = value;
          var err = self.J("yt-dialog-fg", key);
          if (err) {
          ...
          this.g.show();
          self.XF("yt-uix-kbd-nav-move-to", err || key);
          updateTemp(this);
          if (!millis) {
            if (!d) {
              millis = (0, self.z)(function(ev) {
                if (self.kq(ev.target, "yt-dialog-base")) {
                  make_title(this);
                }
              }, this);
              key = self.J("yt-dialog-base", key);
              this.l = self.rF(key, "click", millis);
            }
          }
          this.qj(value, "overlay-shown");
          self.XF("yt-uix-overlay-shown", value);
        }
      }
    };
    /**
     ...
     */
    self.h.Cc = function(elem) {
      return self.J("yt-dialog-content", elem.overlayContentNode || elem);
    };
    /**
     * @param {string} options
     * @return {undefined}
     */
    self.h.hide = function(options) {
      if (!(options && options.disabled)) {
        self.XF("yt-uix-overlay-hide");
      }
    };
    /**
     * @param {Object} input
     * @return {undefined}
     */
    self.h.show = function(input) {
      this.yv(input);
    };
    self.A(old, assert);
    self.ya(old);
    self.h = old.prototype;
    /**
     * @return {undefined}
     */
    self.h.register = function() {
     ...
     * @return {undefined}
     */
    self.h.Uy = function(walkers, deepDataAndEvents) {
      /** @type {number} */
      this.g = 0;
     ...
     * @return {undefined}
     */
    self.h.TE = function(walkers, fix, orig) {
     ...
     * @return {undefined}
     */
    self.h.qq = function(isXML, fix, orig) {
      if (orig.changedTouches) {
        this.g = (0, self.F)();
    ...
    self.va("yt.uix.widgets_", arr2, void 0);
    self.A(target, self.yN);
    self.A(q, self.yN);
    self.A(parent, self.yN);
    self.A(obj, self.yN);
    var conf = new self.zN("subscription-subscribe", q);
    var touchstart = new self.zN("subscription-subscribe-loading", target);
    var touchmove = new self.zN("subscription-subscribe-loaded", target);
    var keypress = new self.zN("subscription-subscribe-success", parent);
    var curr = new self.zN("subscription-unsubscribe", obj);
    var touchend = new self.zN("subscription-unsubscirbe-loading", target);
    var keyup = new self.zN("subscription-unsubscribe-loaded", target);
    var mousemove = new self.zN("subscription-unsubscribe-success", target);
    var keydown = new self.zN("subscription-enable-ypc", target);
    var contextmenu = new self.zN("subscription-disable-ypc", target);
    var input = {};
    /** @type {Array} */
    var matched = [];
    self.A(props, assert);
    ...
    self.h = props.prototype;
    /**
     * @param {string} type
     * @return {undefined}
     */
    self.h.kw = function(type) {
        ...
        if (!listeners) {
          if (self.ZV()) {
            ...
            if (this.Ba(type, "is-subscribed")) {
              ...
              self.BN(conf, new q(url, player, listeners, charset));
            }
          } else {
            on(this, type);
          }
     ...
     * @return {undefined}
     */
    self.h.tE = function(value, date1, isXML) {
      if (date1) {
     ...
     * @return {undefined}
     */
    self.h.nE = function(node, value) {
      var tmpl = self.$d(node, elm.DG);
      self.U(tmpl, elm.EG, value);
     ...
     * @return {undefined}
     */
    self.h.nJ = function(value) {
      if (this.Ba(value, "ypc-enabled")) {
        self.mq(value, "ypc-enabled");
     ...
     * @return {undefined}
     */
    self.h.QI = function(iface, callback, dataAndEvents) {
      var args = self.$a(arguments, 2);
      (0, self.B)(iface, function(results) {
        callback.apply(this, self.Xa(results, args));
      }, this);
    };
    /**
     * @param {?} isXML
     ...
     * @return {undefined}
     */
    self.h.nj = function(isXML, dataAndEvents, recurring) {
      var applyArgs = increment(this, isXML);
      applyArgs = self.Xa([applyArgs], self.$a(arguments, 1));
      this.QI.apply(this, applyArgs);
    };
    /** @type {function (string): undefined} */
    self.iY.annotations_module = run;
    /** @type {function (Text): undefined} */
    self.iY.creatorendscreen = Class;
