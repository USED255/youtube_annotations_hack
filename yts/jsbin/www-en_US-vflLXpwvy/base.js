...
g.Mb=function(a){if(a instanceof g.Lb&&a.constructor===g.Lb&&a.F===Kb)return a.C;g.xa(a);return"type_error:SafeUrl"};
g.Pb=function(a){if(a instanceof g.Lb)return a;a=a.Xd?a.Vc():String(a);Nb.test(a)||(a="about:invalid#zClosurez");return g.Ob(a)};
g.Qb=function(a){if(a instanceof g.Lb)return a;a=a.Xd?a.Vc():String(a);Nb.test(a)||(a="about:invalid#zClosurez");return g.Ob(a)};
...
g.Zb=function(){this.C="";this.D=Xb;this.F=null};
g.$b=function(a){if(a instanceof g.Zb&&a.constructor===g.Zb&&a.D===Xb)return a.C;g.xa(a);return"type_error:SafeHtml"};
g.bc=function(a){if(a instanceof g.Zb)return a;var b=null;a.Nl&&(b=a.vf());a=g.Ta(a.Xd?a.Vc():String(a));return g.ac(a,b)};
g.ac=function(a,b){var c=new g.Zb;c.C=a;c.F=b;return c};
g.cc=function(a,b){var c=b instanceof g.Lb?b:g.Qb(b);a.href=g.Mb(c)};
g.dc=function(a,b){var c=b instanceof g.Lb?b:g.Qb(b);a.href=g.Mb(c)};
g.ec=function(a,b){return g.ac(b,null)};
g.fc=function(a,b){this.x=g.qa(a)?a:0;this.y=g.qa(b)?b:0};
g.gc=function(a,b){return a==b?!0:a&&b?a.x==b.x&&a.y==b.y:!1};
g.hc=function(a,b){var c=a.x-b.x,d=a.y-b.y;return Math.sqrt(c*c+d*d)};
g.ic=function(a,b){this.width=a;this.height=b};
g.x=function(a){return g.sa(a)?window.document.getElementById(a):a};
g.jc=function(a){var b=window.document;return g.sa(a)?b.getElementById(a):a};
g.lc=function(a,b){g.ab(b,function(b,d){b&&b.Xd&&(b=b.Vc());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:kc.hasOwnProperty(d)?a.setAttribute(kc[d],b):g.Oa(d,"aria-")||g.Oa(d,"data-")?a.setAttribute(d,b):a[d]=b})};
g.nc=function(a){return g.mc(a||window)};
g.mc=function(a){a=a.document;a=g.oc(a)?a.documentElement:a.body;return new g.ic(a.clientWidth,a.clientHeight)};
g.qc=function(a,b,c){return g.pc(window.document,arguments)};
g.pc=function(a,b){var c=String(b[0]),d=b[1];if(!oaa&&d&&(d.name||d.type)){c=["<",c];d.name&&c.push(' name="',g.Ta(d.name),'"');if(d.type){c.push(' type="',g.Ta(d.type),'"');var e={};g.lb(e,d);delete e.type;d=e}c.push(">");c=c.join("")}c=a.createElement(c);d&&(g.sa(d)?c.className=d:g.ya(d)?c.className=d.join(" "):g.lc(c,d));2<b.length&&g.rc(a,c,b,2);return c};
g.rc=function(a,b,c,d){function e(c){c&&b.appendChild(g.sa(c)?a.createTextNode(c):c)}
for(;d<c.length;d++){var f=c[d];!g.za(f)||g.Ba(f)&&0<f.nodeType?e(f):(0,g.z)(paa(f)?g.Ma(f):f,e)}};
g.oc=function(a){return"CSS1Compat"==a.compatMode};
g.sc=function(a){for(var b;b=a.firstChild;)a.removeChild(b)};
g.tc=function(a){return a&&a.parentNode?a.parentNode.removeChild(a):null};
g.uc=function(a){return 9==a.nodeType?a:a.ownerDocument||a.document};
...
g.vc=function(a,b,c,d){a&&!c&&(a=a.parentNode);for(c=0;a&&(null==d||c<=d);){if(b(a))return a;a=a.parentNode;c++}return null};
g.wc=function(a){try{return!!a&&null!=a.location.href&&g.tb(a,"foo")}catch(b){return!1}};
g.xc=function(a,b){if(a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&b.call(void 0,a[c],c,a)};
g.yc=function(a){var b=[];g.xc(a,function(a){b.push(a)});
return b};
zc=function(a,b,c){a.addEventListener?a.addEventListener(b,c,void 0):a.attachEvent&&a.attachEvent("on"+b,c)};
Ac=function(a,b,c){a.removeEventListener?a.removeEventListener(b,c,void 0):a.detachEvent&&a.detachEvent("on"+b,c)};
g.Bc=function(a,b){var c=!1,d=!1;d=void 0===d?!1:d;c=void 0===c?!1:c;g.n.google_image_requests||(g.n.google_image_requests=[]);var e=g.n.document.createElement("img");if(b||c){var f=function(a){b&&b(a);c&&g.La(g.n.google_image_requests,e);Ac(e,"load",f);Ac(e,"error",f)};
zc(e,"load",f);zc(e,"error",f)}d&&(e.referrerPolicy="no-referrer");e.src=a;g.n.google_image_requests.push(e)};
...
g.Kc=function(){if(Hc&&!g.wc(Ic)){var a="."+g.Jc.domain;try{for(;2<a.split(".").length&&!g.wc(Ic);)g.Jc.domain=a=a.substr(a.indexOf(".")+1),Ic=window.parent}catch(b){}g.wc(Ic)||(Ic=window)}return Ic};
...
g.bd=function(a,b,c,d,e){if(Math.random()<(d||a.C))try{if(c instanceof Xc)var f=c;else f=new Xc,g.xc(c,function(a,b){var c=f,d=c.K++,e=Yc(b,a);c.C.push(d);c.F[d]=e});
...
vaa=function(a,b,c){var d=[],e=[];if(1==(g.ya(c)?2:1))return e=[b,a],(0,g.z)(d,function(a){e.push(a)}),qd(e.join(" "));
...
qd=function(a){var b=uaa();b.update(a);return b.Lw().toLowerCase()};
...
return a[Yd]};
g.Zd=function(){g.sd.call(this);this.Ad=new g.Fd(this);this.Sv=this;this.Cm=null};
...
g.Je=function(a,b,c){g.sd.call(this);this.C=a;this.D=b||0;this.F=c;this.hc=(0,g.t)(this.wp,this)};
...
g.$e=function(a){g.sd.call(this);this.H=1;this.D=[];this.G=0;this.C=[];this.F={};this.K=!!a};
...
g.ig=function(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=g.hg(e[1]||"");for(var f in b)if(c||!g.cb(e,f))e[f]=b[f];return g.Uc(a,e)+d};
Saa=function(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=g.Nc(a)[1]||null,e=g.Pc(a);d&&e?(d=c,c=g.Nc(a),d=g.Nc(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?g.Pc(c)==e&&(Number(g.Nc(c)[4]||null)||null)==(Number(g.Nc(a)[4]||null)||null):!0;for(var f in kg)(d=g.D(kg[f]))&&(c||lg(a,f))&&(b[f]=d);if(c||lg(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=-(new Date).getTimezoneOffset();return b};
lg=function(a,b){var c=g.D("CORS_HEADER_WHITELIST")||{},d=g.Pc(a);return d?(c=c[d])?g.Ia(c,b):!1:!0};
...
ng=function(a,b){var c=g.D("XSRF_FIELD_NAME",void 0),d=g.D("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.ha,k=g.D("XSRF_FIELD_NAME",void 0),l;b.headers&&(l=b.headers["Content-Type"]);b.bx||g.Pc(a)&&!b.withCredentials&&g.Pc(a)!=window.document.location.hostname||"POST"!=b.method||l&&"application/x-www-form-urlencoded"!=l||b.ha&&b.ha[k]||(f||(f={}),f[c]=d);f&&g.sa(e)&&(e=g.hg(e),g.lb(e,f),e=b.Qs&&"JSON"==b.Qs?JSON.stringify(e):g.Tc(e));f=e||f&&!g.eb(f);!pg&&f&&"POST"!=b.method&&(pg=!0,g.wf(Error("AJAX request with postData should use POST")));
return e};
...
return d};
sg=function(a){if(g.Ba(a))for(var b in a)"html_content"==b||g.Pa(b,"_html")?a[b]=g.ec(g.Jb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax"),a[b]):sg(a[b])};
...
g.H=function(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=g.Fg(a,b,c,d);if(e)return e;e=++Gg.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in window.document);var k=f?function(d){d=new g.Ag(d);if(!g.vc(d.relatedTarget,function(b){return b==a},!0))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new g.Ag(b);
...
Mg=function(){g.sd.call(this);this.C=[]};
...
g.Rg=function(a,b,c,d,e,f){f=f||{};f.name=c||g.D("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||g.D("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(!(!a||!e||5<=Pg||(c=a.stacktrace,d=a.columnNumber,a.hasOwnProperty("params")&&(f.params=JSON.stringify(a.params)),a=g.xd(a),c=c||a.stack,e=a.lineNumber.toString(),(0,window.isNaN)(e)||(0,window.isNaN)(d)||(e=e+":"+d),Qg[a.message]||0<=c.indexOf("/YouTubeCenter.js")||
...
[{token:w,scope:y}]}delete Sg[c];m=l;m.requestTimeMs=b;(y=g.D("EVENT_ID",void 0))&&g.$f("enable_gel_web_client_event_id")&&(q=(g.D("BATCH_CLIENT_COUNTER",void 0)||0)+1,q>$aa&&(q=1),g.uf("BATCH_CLIENT_COUNTER",q),m.serializedClientEventId={serializedEventId:y,clientCounter:q});g.ch(e,d,l,{retry:aba.has(d)})}c=k;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=
d;delete g.Zg[a]}}g.eb(g.Zg)||g.Wg()}};
...
oh=function(a,b){var c={"X-Goog-Visitor-Id":g.D("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return c;var d;a?d="Bearer "+g.r("gapi.auth.getToken")().zZ:d=rd([]);d&&(c.Authorization=d,c["X-Goog-AuthUser"]=g.D("SESSION_INDEX",0));return c};
ph=function(a){a=Object.assign({},a);delete a.Authorization;var b=rd();if(b){var c=new Ke;c.update(g.D("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();g.za(b);g.Cb();c=Bb;for(var d=[],e=0;e<b.length;e+=3){var f=b[e],k=e+1<b.length,l=k?b[e+1]:0,m=e+2<b.length,q=m?b[e+2]:0,w=f>>2;f=(f&3)<<4|l>>4;l=(l&15)<<2|q>>6;q&=63;m||(q=64,k||(l=64));d.push(c[w],c[f],c[l],c[q])}b=d.join("");a.hash=b}return a};
...
g.di=function(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=g.Za,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=g.Mb(g.Pb(a)),"about:invalid#zClosurez"===a?a="":(a=g.$b(g.bc(a)),a=g.Ra(g.Xe(a))),g.Qa(a)||(a=g.qc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),g.uc(a).body.appendChild(a))):e?og(a,b,"POST",e,d):g.D("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?og(a,b,"GET","",d):eba(a,b))};
...
g.gi=function(a,b,c){var d=g.D("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=g.Pc(window.location.href);e&&d.push(e);e=g.Pc(a);if(g.Ia(d,e)||!e&&g.Oa(a,"/"))if(g.$f("autoescape_tempdata_url")&&(d=window.document.createElement("a"),g.cc(d,a),a=d.href),a&&(a=g.Qc(a),d=a.indexOf("#"),a=0>d?a:a.substr(0,d))){if(b.itct||b.ved)b.csn=b.csn||g.Th();c?(c=(0,window.parseInt)(c,10),(0,window.isFinite)(c)&&0<c&&(a="ST-"+g.Ya(a).toString(36),b=b?g.Tc(b):"",g.rh(a,b,c||5))):(c="ST-"+g.Ya(a).toString(36),b=b?g.Tc(b):"",
g.rh(c,b,5))}};
g.hi=function(a){var b=void 0===b?{}:b;var c=void 0===c?"":c;var d=void 0===d?window:d;g.dc(d.location,g.Uc(a,b)+c)};
...
jba=function(){var a=window.location.protocol,b=oi.getEntriesByType("resource");b=(0,g.Wi)(b,function(b){return 0==b.name.indexOf(a+"//web.archive.org/web/20180625031906/https://fonts.gstatic.com/s/")});
...
bj=function(a,b){g.sd.call(this);this.H=this.na=a;this.N=b;this.K=!1;this.api={};this.aa=this.W=null;this.J=new g.$e;g.vd(this,this.J);this.D={};this.la=this.ia=this.F=this.kb=this.C=null;this.V=!1;this.G=this.R=null;this.Sa={};this.sb=["onReady"];this.ab=null;this.pb=window.NaN;this.Y={};aj(this);this.Xh("WATCH_LATER_VIDEO_ADDED",this.GG.bind(this));this.Xh("WATCH_LATER_VIDEO_REMOVED",this.HG.bind(this));this.Xh("onAdAnnounce",this.Rv.bind(this));this.xb=new Mg(this);g.vd(this,this.xb)};
...
g.gb(a.Y,String(d),!0)};
return c};
gj=function(a){(0,g.kj)("dcp");a.cancel();aj(a);a.la=null;a.C&&(a.C.loaded=!1);var b=dj(a);b&&(ej(a)||!hj(a)?a.G=b:(b&&b.destroy&&b.destroy(),a.G=null));g.sc(a.na)};
hj=function(a){return a.C&&a.C.args&&a.C.args.fflags?-1!=a.C.args.fflags.indexOf("player_destroy_old_version=true"):!1};
g.nj=function(a,b){a=g.sa(a)?g.jc(a):a;var c=g.lj+"_"+g.Da(a),d=g.mj[c];if(d)return d.jm(b),d.api;d=new bj(a,c);g.mj[c]=d;g.F("player-added",d.api);g.td(d,g.u(xba,d));g.Bf(function(){d.jm(b)},0);
return d.api};
...
Eba=function(){uj++;var a=g.nc(),b=new g.Cc(0,0,a.width,a.height);vj("vph",a.height);vj("vpw",a.width);(0,g.kj)("vpc");a=window.document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[],e=!0;wj.start();for(var f=0;f<c;f++){var k=a[f];if(xj(k,b)){var l=zba(k);l.then(Aba);d.push(l);yj.push(l);k.loadTime||(e=!1)}}e&&vj("yt_eil",1);(0,g.kj)("vpcc");b=g.we(d).then(Bba);g.ye(b,Cba);b.then(Dba);yj.push(b);return b};
...
Bba=function(a){var b=g.nc();b=new g.Cc(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;xj(a[d].zB,b)&&c<f&&(c=f)}return c};
...
jk=function(a){g.Dj(g.Tc({spfreload:"1",url:a.detail.url,reason:a.detail.reason}))};
...
Zj=function(a,b){var c=a&&a.spfCached,d=a&&a.spfPrefetched,e=[];c&&!d&&null!=b&&(e=Iba(b));g.D("EXP_DEBUG_PREFETCH")&&(e.sort(),c={a:"updatePlayerVarsForCachedLoad",cached:c,prefetched:d,deleted:e.join("")},g.Dj(g.Tc(c)))};
...
cca=function(){var a=g.x("yt-push-prompt-modal-bg");sk=g.$f("service_worker_push_prompt_modal_ignore_click");a?tk(a):(a=g.qc("div",{id:"yt-push-prompt-modal-bg"}),tk(a),window.document.body.appendChild(a),g.Jg(window.document,"click",dca))};
rk=function(){var a=g.x("yt-push-prompt-modal-bg");a&&g.tc(a)};
...
g.Ak=g.Ak||{};g.n=this;Ca="closure_uid_"+(1E9*Math.random()>>>0);caa=0;g.A=Date.now||function(){return+new Date};g.Jc=window.document;g.Bk=window;g.v(g.Ea,Error);g.Ea.prototype.name="CustomError";g.Ha=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(g.sa(a))return g.sa(b)&&1==b.length?a.indexOf(b,0):-1;
...
g.qh=new g.Db("undefined"==typeof window.document?null:window.document);g.qh.F=3950;g.$k=g.Fb(null);var oaa;oaa=!g.C||g.yb(9);g.uca=!g.Lk&&!g.C||g.C&&g.yb(9)||g.Lk&&g.wb("1.9.1");g.al=g.C&&!g.wb("9");g.vca=g.C||g.zd||g.yd;g.Ib.prototype.Xd=!0;g.Ib.prototype.Vc=function(){return this.C};
g.Ib.prototype.toString=function(){return"Const{"+this.C+"}"};
g.Hb={};g.Jb("");g.wca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.xca=RegExp("^[^\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.bl=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]");g.Lb.prototype.Xd=!0;g.Lb.prototype.Vc=function(){return this.C};
g.Lb.prototype.Nl=!0;g.Lb.prototype.vf=function(){return 1};
var Nb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Kb={};g.Ob("about:blank");g.Sb.prototype.Xd=!0;g.Rb={};g.Sb.prototype.Vc=function(){return this.C};
g.cl=g.Tb("");g.dl=RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))","g");g.yca=RegExp("\\b(hsl|hsla|rgb|rgba|matrix|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-0-9a-z.%, ]+\\)","g");g.Vb.prototype.Xd=!0;g.Ub={};g.Vb.prototype.Vc=function(){return this.C};
g.el=g.Wb("");g.Zb.prototype.Nl=!0;g.Zb.prototype.vf=function(){return this.F};
g.Zb.prototype.Xd=!0;g.Zb.prototype.Vc=function(){return this.C};
var Xb={};g.ac("<!DOCTYPE html>",0);g.fl=g.ac("",0);g.gl=g.ac("<br>",0);g.h=g.fc.prototype;g.h.clone=function(){return new g.fc(this.x,this.y)};
g.h.equals=function(a){return a instanceof g.fc&&g.gc(this,a)};
...
g.h.translate=function(a,b){a instanceof g.fc?(this.x+=a.x,this.y+=a.y):(this.x+=Number(a),g.ua(b)&&(this.y+=b));return this};
g.h.scale=function(a,b){var c=g.ua(b)?b:a;this.x*=a;this.y*=c;return this};g.h=g.ic.prototype;g.h.clone=function(){return new g.ic(this.width,this.height)};
...
g.h.scale=function(a,b){var c=g.ua(b)?b:a;this.width*=a;this.height*=c;return this};var kc={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};var zca;zca={iP:"allow-forms",jP:"allow-modals",kP:"allow-orientation-lock",lP:"allow-pointer-lock",mP:"allow-popups",nP:"allow-popups-to-escape-sandbox",oP:"allow-presentation",pP:"allow-same-origin",qP:"allow-scripts",rP:"allow-top-navigation",sP:"allow-top-navigation-by-user-activation"};g.Aca=g.Gb(function(){return g.yc(zca)});g.h=g.Cc.prototype;g.h.clone=function(){return new g.Cc(this.left,this.top,this.width,this.height)};
g.h.contains=function(a){return a instanceof g.fc?a.x>=this.left&&a.x<=this.left+this.width&&a.y>=this.top&&a.y<=this.top+this.height:this.left<=a.left&&this.left+this.width>=a.left+a.width&&this.top<=a.top&&this.top+this.height>=a.top+a.height};
...
g.h.translate=function(a,b){a instanceof g.fc?(this.left+=a.x,this.top+=a.y):(this.left+=a,g.ua(b)&&(this.top+=b));return this};
g.h.scale=function(a,b){var c=g.ua(b)?b:a;this.left*=a;this.width*=a;this.top*=c;this.height*=c;return this};g.hl=g.Lk?"MozUserSelect":g.yd||g.Jk?"WebkitUserSelect":null;var Hc,Ic;g.Bca=Object.prototype.hasOwnProperty;Hc=g.Gc(window);Ic=Hc&&window.parent||window;var qaa=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;var Cca=/^https?:\/\/(\w|-)+\.cdn\.ampproject\.(net|org)(\?|\/|$)/;Xc.prototype.getUrl=function(a,b,c,d){a=a+"//"+b+c;var e=saa(this)-c.length-d.length;if(0>e)return"";this.C.sort(function(a,b){return a-b});
c=null;b="";for(var f=0;f<this.C.length;f++)for(var k=this.C[f],l=this.F[k],m=0;m<l.length;m++){if(!e){c=null==c?k:c;break}var q=$c(l[m],this.D,",$");if(q){q=b+q;if(e>=q.length){e-=q.length;a+=q;b=this.D;break}else this.H&&(b=e,q[b-1]==this.D&&--b,a+=q.substr(0,b),b=this.D,e=0);c=null==c?k:c}}f="";this.G&&null!=c&&(f=b+this.G+"="+c);return a+f+d};var il=null;var hd=g.n.performance,Dca=!!(hd&&hd.mark&&hd.measure&&hd.clearMarks),fd=g.Gb(function(){var a;if(a=Dca){var b;if(null===il){il="";try{a="";try{a=g.n.top.location.hash}catch(c){a=g.n.location.hash}a&&(il=(b=a.match(/\bdeid=([\d,]+)/))?b[1]:"")}catch(c){}}b=il;a=!!b.indexOf&&0<=b.indexOf("1337")}return a});
gd.prototype.disable=function(){this.C=!1;this.events!=this.F.google_js_reporting_queue&&(fd()&&g.z(this.events,g.id),this.events.length=0)};
...
gd.prototype.end=function(a){if(this.C&&g.ua(a.value)){var b=dd()||cd();a.duration=b-a.value;b="goog_"+a.uniqueId+"_end";hd&&fd()&&hd.mark(b);this.C&&this.events.push(a)}};ld.prototype.F=function(a,b,c,d,e){e=e||"jserror";try{var f=new Xc;f.H=!0;ad(f,1,"context",a);b.error&&b.meta&&b.id||(b=g.od(b));b.msg&&ad(f,2,"msg",b.msg.substring(0,512));b.file&&ad(f,3,"file",b.file);0<b.line&&ad(f,4,"line",b.line);var k=b.meta||{};if(d)try{d(k)}catch(R){}b=[k];f.C.push(5);f.F[5]=b;var l=g.Wc(),m=new Vc(g.n.location.href,g.n,!1);b=null;var q=l.length-1;for(d=q;0<=d;--d){var w=l[d];!b&&Cca.test(w.url)&&(b=w);if(w.url&&!w.Gq){m=w;break}}w=null;var y=l.length&&l[q].url;0!=m.depth&&
y&&(w=l[q]);var I=new raa(m,w);I.F&&ad(f,6,"top",I.F.url||"");ad(f,7,"url",I.C.url||"");g.bd(this.D,e,f,c)}catch(R){try{g.bd(this.D,e,{context:"ecmserr",rctx:a,msg:g.nd(R),url:I&&I.C.url},c)}catch(V){}}return!0};
g.ea(md,Lc);var ed,jd;ed=g.Kc();jd=new gd;g.kd=new function(){var a=void 0===a?g.Bk:a;this.G="http:"===a.location.protocol?"http:":"https:";this.F="pagead2.googlesyndication.com";this.D="/pagead/gen_204?id=";this.C=.01};
g.jl=new ld;"complete"==ed.document.readyState?ed.google_measure_js_timing||jd.disable():jd.C&&zc(ed,"load",function(){ed.google_measure_js_timing||jd.disable()});var kl;kl={};g.ll=(kl[8]="google_prev_ad_formats_by_region",kl[9]="google_prev_ad_slotnames_by_region",kl);g.ml=(new Date).getTime();g.sd.prototype.Dc=!1;g.sd.prototype.ob=function(){return this.Dc};
...
g.wd.prototype.preventDefault=function(){this.Et=!1};var Rd,Fca,zaa;g.Eca=!g.C||g.yb(9);Rd=!g.C||g.yb(9);Fca=g.C&&!g.wb("9");zaa=function(){if(!g.n.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
g.n.addEventListener("test",g.va,b);g.n.removeEventListener("test",g.va,b);return a}();g.nl=Ad("TransitionEnd");
g.ol={TP:"click",wW:"rightclick",BQ:"dblclick",Sg:"mousedown",Tg:"mouseup",lU:"mouseover",kU:"mouseout",jU:"mousemove",hU:"mouseenter",iU:"mouseleave",Rg:"mousecancel",FW:"selectionchange",GW:"selectstart",qZ:"wheel",lS:"keypress",kS:"keydown",mS:"keyup",MP:"blur",qR:"focus",CQ:"deactivate",rR:"focusin",sR:"focusout",QP:"change",pW:"reset",EW:"select",hX:"submit",YR:"input",WV:"propertychange",ZQ:"dragstart",UQ:"drag",WQ:"dragenter",YQ:"dragover",XQ:"dragleave",DROP:"drop",VQ:"dragend",sX:"touchstart",
rX:"touchmove",qX:"touchend",pX:"touchcancel",LP:"beforeunload",oQ:"consolemessage",rQ:"contextmenu",GQ:"devicechange",HQ:"devicemotion",IQ:"deviceorientation",LQ:"DOMContentLoaded",ERROR:"error",MR:"help",LOAD:"load",NT:"losecapture",PU:"orientationchange",bW:"readystatechange",rW:"resize",zW:"scroll",FY:"unload",OP:"canplay",PP:"canplaythrough",aR:"durationchange",dR:"emptied",ENDED:"ended",HT:"loadeddata",IT:"loadedmetadata",PAUSE:"pause",PLAY:"play",PLAYING:"playing",ZV:"ratechange",BW:"seeked",
DW:"seeking",dX:"stalled",jX:"suspend",nX:"timeupdate",QY:"volumechange",RY:"waiting",aX:"sourceopen",ZW:"sourceended",YW:"sourceclosed",KO:"abort",UPDATE:"update",JY:"updatestart",HY:"updateend",KR:"hashchange",XU:"pagehide",YU:"pageshow",SV:"popstate",uQ:"copy",gV:"paste",yQ:"cut",FP:"beforecopy",GP:"beforecut",JP:"beforepaste",OU:"online",JU:"offline",MESSAGE:"message",nQ:"connect",aS:"install",LO:"activate",oR:"fetch",uR:"foreignfetch",bU:"messageerror",eX:"statechange",IY:"updatefound",tQ:"controllerchange",
wP:Ad("AnimationStart"),uP:Ad("AnimationEnd"),vP:Ad("AnimationIteration"),tX:g.nl,KV:"pointerdown",QV:"pointerup",JV:"pointercancel",NV:"pointermove",PV:"pointerover",OV:"pointerout",LV:"pointerenter",MV:"pointerleave",DR:"gotpointercapture",OT:"lostpointercapture",mU:"MSGestureChange",nU:"MSGestureEnd",oU:"MSGestureHold",pU:"MSGestureStart",qU:"MSGestureTap",rU:"MSGotPointerCapture",sU:"MSInertiaStart",tU:"MSLostPointerCapture",uU:"MSPointerCancel",vU:"MSPointerDown",wU:"MSPointerEnter",xU:"MSPointerHover",
yU:"MSPointerLeave",zU:"MSPointerMove",AU:"MSPointerOut",BU:"MSPointerOver",CU:"MSPointerUp",TEXT:"text",mX:g.C?"textinput":"textInput",kQ:"compositionstart",lQ:"compositionupdate",jQ:"compositionend",HP:"beforeinput",gR:"exit",FT:"loadabort",GT:"loadcommit",JT:"loadredirect",KT:"loadstart",LT:"loadstop",sW:"responsive",WW:"sizechanged",GY:"unresponsive",MY:"visibilitychange",gX:"storage",RQ:"DOMSubtreeModified",MQ:"DOMNodeInserted",OQ:"DOMNodeRemoved",QQ:"DOMNodeRemovedFromDocument",NQ:"DOMNodeInsertedIntoDocument",
JQ:"DOMAttrModified",KQ:"DOMCharacterDataModified",KP:"beforeprint",hP:"afterprint",IP:"beforeinstallprompt",AP:"appinstalled"};g.v(g.Bd,g.wd);var Gca={2:"touch",3:"pen",4:"mouse"};
...
var Ge=ce;g.v(g.Ee,g.Ea);g.Ee.prototype.name="cancel";g.v(g.Je,g.sd);g.h=g.Je.prototype;g.h.hb=0;g.h.X=function(){g.Je.M.X.call(this);this.stop();delete this.C;delete this.F};
...
return e};var Ze={'"':'\\"',"\\":"\\\\","/":"\\/","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\u000b"},Jaa=/\uffff/.test("\uffff")?/[\\"\x00-\x1f\x7f-\uffff]/g:/[\\"\x00-\x1f\x7f-\xff]/g;g.v(g.$e,g.sd);g.h=g.$e.prototype;g.h.subscribe=function(a,b,c){var d=this.F[a];d||(d=this.F[a]=[]);var e=this.H;this.C[e]=a;this.C[e+1]=b;this.C[e+2]=c;this.H=e+3;d.push(e);return e};
...
g.Ag.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Eg=g.r("ytEventsEventsListeners")||{};g.p("ytEventsEventsListeners",Eg,void 0);var Gg=g.r("ytEventsEventsCounter")||{count:0};g.p("ytEventsEventsCounter",Gg,void 0);var Hg=g.Gb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});g.v(g.Lg,g.sd);g.Lg.prototype.W=function(a){this.C=new g.fc(g.Cg(a),g.Dg(a))};
g.Lg.prototype.R=function(){if(this.C){var a=g.ah();if(0!=this.D){var b=g.hc(this.K,this.C)/(a-this.D);this.F[this.H]=.5<Math.abs((b-this.G)/this.G)?1:0;for(var c=0,d=0;4>d;d++)c+=this.F[d]||0;3<=c&&this.hc();this.G=b}this.D=a;this.K=this.C;this.H=(this.H+1)%4}};
g.Lg.prototype.X=function(){g.Ef(this.N);g.Ig(this.J)};g.ea(Mg,g.sd);Mg.prototype.Va=function(a){for(var b=0;b<this.C.length;b++)if(this.C[b]==a){this.C.splice(b,1);a.target.removeEventListener(a.name,a.ne);break}};
Mg.prototype.X=function(){for(;this.C.length;){var a=this.C.pop();a.target.removeEventListener(a.name,a.ne)}g.sd.prototype.X.call(this)};var Xaa={enablejsapi:1},Yaa={};Ng.prototype.clone=function(){var a=new Ng,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==g.xa(c)?a[b]=g.ib(c):a[b]=c}return a};var Qg={},Pg=0;var $aa,Zaa,dh,aba,Ug;$aa=Math.pow(2,16)-1;Zaa={log_event:"events",log_interaction:"interactions"};dh=Object.create(null);dh.log_event="GENERIC_EVENT_LOGGING";dh.log_interaction="INTERACTION_LOGGING";aba=new window.Set(["log_event"]);Ug={};g.Yg=0;g.Zg=g.r("ytLoggingTransportLogPayloadsQueue_")||{};g.p("ytLoggingTransportLogPayloadsQueue_",g.Zg,void 0);var Sg=g.r("ytLoggingTransportTokensToCttTargetIds_")||{};g.p("ytLoggingTransportTokensToCttTargetIds_",Sg,void 0);
...
/*
     FILE ARCHIVED ON 03:19:06 Jun 25, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:40:54 Jan 26, 2024.
...
/*
playback timings (ms):
  exclusion.robots: 2.289
  exclusion.robots.policy: 2.278
  cdx.remote: 0.095
  esindex: 0.008
  LoadShardBlock: 394.891 (6)
  PetaboxLoader3.datanode: 386.1 (7)
  load_resource: 116.937
  PetaboxLoader3.resolve: 59.37
*/